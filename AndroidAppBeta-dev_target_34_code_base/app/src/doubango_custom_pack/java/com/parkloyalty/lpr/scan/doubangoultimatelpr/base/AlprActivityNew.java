...
// */
//package com.parkloyalty.lpr.vehiclemode.doubangoultimatelpr.base;
//
...
//
//import com.parkloyalty.lpr.vehiclemode.doubangoultimatelpr.AlprCameraFragmentNew;
//import com.parkloyalty.lpr.vehiclemode.doubangoultimatelpr.license.AlprLicenseActivatorNew;
//import com.parkloyalty.lpr.vehiclemode.doubangoultimatelpr.utils.AlprUtilsNew;
//import com.parkloyalty.lpr.vehiclemode.doubangoultimatelpr.views.AlprPlateViewNew;
//
...
// */
//public abstract class AlprActivityNew extends AppCompatActivity implements AlprCameraFragmentNew.AlprCameraFragmentSink {
//
...
//
//        AlprPlateViewNew mAlprPlateView;
//        Size mImageSize;
//        long mTotalDuration = 0;
//        int mOrientation = 0;
//
//        void setAlprPlateView(@NonNull final AlprPlateViewNew view) {
//            mAlprPlateView = view;
//        }
//
...
//            Log.d(TAG, AlprUtilsNew.resultToString(result));
...
//
//    private AlprPlateViewNew mAlprPlateView;
//
//    @Override
...
//        String tokenFile = AlprLicenseActivatorNew.tokenFile(this);
//        if (!tokenFile.isEmpty()) {
//            try {
//                config.put("license_token_data", AlprLicenseActivatorNew.tokenData(tokenFile));
//            } catch (JSONException e) {
//                e.printStackTrace();
//            }
//        }
//
//        final UltAlprSdkResult alprResult = AlprUtilsNew.assertIsOk(UltAlprSdkEngine.init(
//                getAssets(),
//                config.toString(),
//                mParallelDeliveryCallback
//        ));
//        Log.i(TAG,"ALPR engine initialized: " + AlprUtilsNew.resultToString(alprResult));
//
...
//            tokenFile = AlprLicenseActivatorNew.activate(this, getActivationServerUrl(), getActivationMasterOrSlaveKey(), false);
//            if (!tokenFile.isEmpty()) {
//                try {
//                    config.put("license_token_data", AlprLicenseActivatorNew.tokenData(tokenFile));
//                } catch (JSONException e) {
//                    e.printStackTrace();
//                }
//                AlprUtilsNew.assertIsOk(UltAlprSdkEngine.init(
//                        getAssets(),
//                        config.toString(),
//                        mParallelDeliveryCallback
//                ));
...
//        AlprUtilsNew.assertIsOk(UltAlprSdkEngine.warmUp(ULTALPR_SDK_IMAGE_TYPE.ULTALPR_SDK_IMAGE_TYPE_YUV420P));
//    }
//
//    @Override
...
//        // block until the end.
//        final UltAlprSdkResult result = AlprUtilsNew.assertIsOk(UltAlprSdkEngine.deInit());
//        Log.i(TAG,"ALPR engine deInitialized: " + AlprUtilsNew.resultToString(result));
//
//        super.onDestroy();
//    }
//
...
//
//    @Override
//    public void setAlprPlateView(@NonNull final AlprPlateViewNew view) {
//        mAlprPlateView = view;
...
//            Log.d(TAG, AlprUtilsNew.resultToString(result));
//        } else {
//            Log.e(TAG, AlprUtilsNew.resultToString(result));
//        }
//
...
//            mAlprPlateView.setResult(image, result, (jpegOrientation % 180) == 0 ? imageSize : new Size(imageSize.getHeight(), imageSize.getWidth()), durationInMillis, jpegOrientation);
//        }
//    }
//
//    /**
