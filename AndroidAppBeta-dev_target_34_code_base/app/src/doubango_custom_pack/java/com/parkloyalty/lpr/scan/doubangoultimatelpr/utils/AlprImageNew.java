...
//
//public class AlprImageNew {
//
//    Image mImage;
//    final AtomicInteger mRefCount;
//
//    private AlprImageNew(final Image image) {
//        assert image != null;
//        mImage = image;
//        mRefCount = new AtomicInteger(0);
//    }
//
//    public static AlprImageNew newInstance(final Image image) {
//        return new AlprImageNew(image);
//    }
//
