...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    private val onImageAvailableListener = ImageReader.OnImageAvailableListener {
        backgroundHandler?.post(ImageSaver(it.acquireNextImage(), file,mDb))
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerViewImage = view.findViewById(R.id.recycler_imageview_camera2)
    ...
    private fun initDB() {
        ...
        bannerList.clear()
        bannerList = mDb?.dbDAO?.getCitationImage() as java.util.ArrayList<CitationImagesModel>
...
//                    Log.d(TAG, file.toString())
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.done -> {
                requireActivity().setResult(StarPrinterActivity.RESULT_OK, null)
...
//        private val MAX_PREVIEW_HEIGHT = 1080
         ...
         */
        @JvmStatic private fun chooseOptimalSize(choices: Array<Size>, textureViewWidth: Int,
    ...
    private var imageAdapter: camera2ImageAdapter? = null
    private var bannerList = java.util.ArrayList<CitationImagesModel>()
...
//        }
        imageAdapter = camera2ImageAdapter(activity!!,listData,object : camera2ImageAdapter.ListItemSelectListener {
