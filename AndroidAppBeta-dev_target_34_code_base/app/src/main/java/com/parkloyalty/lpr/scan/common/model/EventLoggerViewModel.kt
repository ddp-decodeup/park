...
@HiltViewModel
class EventLoggerViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitLocationUpdateApi(pushEventRequest: LocUpdateRequest?) {
        disposables.add(
            service.executeLocationUpdateAPI(pushEventRequest)
