...
@HiltViewModel
class PushEventViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitPushEventApi(pushEventRequest: PushEventRequest?) {
        disposables.add(
            service.executePushEventAPI(pushEventRequest)
