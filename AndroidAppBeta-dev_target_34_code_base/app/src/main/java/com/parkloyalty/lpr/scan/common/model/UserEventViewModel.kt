...
@HiltViewModel
class UserEventViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitEventLoginApi(authenticationRequest: UserEventRequest?) {
        disposables.add(
            service.executeEventLoginAPI(authenticationRequest)
