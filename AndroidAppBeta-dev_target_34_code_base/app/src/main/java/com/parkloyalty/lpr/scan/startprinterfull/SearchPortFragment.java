...
//        Toast.makeText(getActivity(), "search fragment ", Toast.LENGTH_LONG).show();
        ...
        switch (tag) {
            ...
            case INTERFACE_SELECT_DIALOG: {
                ...
                if (selectedInterfaces != null) {
                    addTitle("List");
//                    Toast.makeText(getActivity(), " if [0] "+selectedInterfaces[0], Toast.LENGTH_SHORT).show();
...
//                            Toast.makeText(getActivity(), " else [0] "+selectedInterface, Toast.LENGTH_SHORT).show();
...
//                            .show();
            ...
            case PAPER_SIZE_SELECT_DIALOG: {
                ...
                Toast.makeText(getActivity(), " mPaperSize  "+mPaperSize, Toast.LENGTH_SHORT).show();
                if (ModelCapability.canSetDrawerOpenStatus(mModelIndex)) {
                    ...
                    Toast.makeText(getActivity(), " mPaperSize  registerPrinter", Toast.LENGTH_SHORT).show();
    ...
    private void showPaperSizeOrDrawerOpenActiveSelectDialog() {
        ...
        Toast.makeText(getActivity(),destinationDevicePaperSize+" paper size"+ mPrinterSettingIndex,Toast.LENGTH_SHORT).show();

        if (mPrinterSettingIndex != 0) {
            Toast.makeText(getActivity(),"default 0",Toast.LENGTH_SHORT).show();
        ...
        if (mModelIndex == ModelCapability.SP700) {
            ...
            Toast.makeText(getActivity(),"else  0" + mPrinterSettingIndex,Toast.LENGTH_SHORT).show();
            if (mPrinterSettingIndex == 0) {    // Destination device
                ...
                if (ModelCapability.canSetDrawerOpenStatus(mModelIndex)) {
                    ...
                    Toast.makeText(getActivity(),"registerPrinter"  ,Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(getActivity(),mPrinterSettingIndex+" mPrinterSettingIndex",Toast.LENGTH_SHORT).show();
...
//        Toast.makeText(getActivity(),mModelName+"  =mModelName",Toast.LENGTH_SHORT).show();
    ...
    private class SearchTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void doNotUse) {
            Toast.makeText(getActivity(),"BL "+mPortList.size(),Toast.LENGTH_SHORT).show();
