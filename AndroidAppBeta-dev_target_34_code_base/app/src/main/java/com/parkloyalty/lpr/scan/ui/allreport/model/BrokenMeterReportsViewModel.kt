...
@HiltViewModel
class BrokenMeterReportsViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitBrokenMeterReportSubmitApi(brokenMeterRequest: BrokenMeterReportRequest?) {
        disposables.add(
                service.executeBrokenMeterReportAPI(brokenMeterRequest)
