...
@HiltViewModel
class CurbReportViewModel  @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitCurbReportSubmitApi(curbRequest: CurbRequest?) {
        disposables.add(
                service.executeCurbReportAPI(curbRequest)
