...
@HiltViewModel
class FullTimeReportViewModel  @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitFullTimeReportSubmitApi(fullTimeRequest: FullTimeRequest?) {
        disposables.add(
                service.executeFullTimeReportAPI(fullTimeRequest)
