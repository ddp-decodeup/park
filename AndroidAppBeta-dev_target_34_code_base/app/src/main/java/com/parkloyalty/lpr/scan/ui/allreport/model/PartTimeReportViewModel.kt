...
@HiltViewModel
class PartTimeReportViewModel  @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitPartTimeReportSubmitApi(fullTimeRequest: FullTimeRequest?) {
        disposables.add(
                service.executePartTimeReportAPI(fullTimeRequest)
