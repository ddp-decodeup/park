...
@HiltViewModel
class SignReportViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitSignReportAPI(signReportRequest: SignReportRequest?) {
        disposables.add(
                service.executeSignReportAPI(signReportRequest)
