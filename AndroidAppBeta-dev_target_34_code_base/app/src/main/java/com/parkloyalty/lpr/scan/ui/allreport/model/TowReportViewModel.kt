...
@HiltViewModel
class TowReportViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitTowReportSubmitApi(towReportRequest: TowReportRequest?) {
        disposables.add(
            service.executeTowReportAPI(towReportRequest)
