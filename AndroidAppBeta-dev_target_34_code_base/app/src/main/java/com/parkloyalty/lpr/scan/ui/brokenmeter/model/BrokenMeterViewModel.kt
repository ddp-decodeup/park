...
@HiltViewModel
class BrokenMeterViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitBrokenMeterSubmitApi(brokenMeterRequest: BrokenMeterRequest?) {
        disposables.add(
            service.executeBrokenMeterAPI(brokenMeterRequest)
