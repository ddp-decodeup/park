...
import com.parkloyalty.lpr.scan.databinding.ActivityLprDetails2Binding
...
import com.parkloyalty.lpr.scan.ui.check_setup.activity.LprPreviewActivity.Companion.savePrintImagePath
...
import com.parkloyalty.lpr.scan.util.AppUtils.hearingDateAfterThresholdDifferenceDays
...
import com.parkloyalty.lpr.scan.util.ExpiryDateTextWatcher
...
/*Phase 2*/
@AndroidEntryPoint
class LprDetails2Activity : BaseActivity(), CustomDialogHelper {
...
//            mAutoComTextViewVinNum!!.setText(vinOCRText)
    ...
    private lateinit var binding: ActivityLprDetails2Binding


    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLprDetails2Binding.inflate(layoutInflater)
        setContentView(binding.root)
        findViewsByViewBinding()
        setupClickListeners()

        setFullScreenUI()
        instanceLprDetails2Activity = this
...
//        }
        ...
        try {
            ...
            ApiLogsClass.writeApiPayloadTex(BaseApplication.instance?.applicationContext!!," Citation form $versionName ")
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    private fun findViewsByViewBinding() {
        linearLayoutVehicleDetails = binding.layoutContentLprDetails2.llVehicleDetails
        appCompatTextViewTicketNumberTitle = binding.layoutContentLprDetails2.txtTicketNumber
        linearLayoutLocationDetails =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.llLocationDetails
        layTicketDate = binding.layoutContentLprDetails2.layTicketDate
        layTicketNum = binding.layoutContentLprDetails2.layTicketNum
        linearLayoutOfficerDetails = binding.layoutContentLprDetails2.llOfficerDetails
        linearLayoutInternalNote =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.llMainInternalNote
        linearLayoutCitationDetails =
            binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.llCitationDetails
        linearLayoutVoilationDetails =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.llVoilationDetails
        layCheckbox1 = binding.layoutContentLprDetails2.layCheckbox1
        layCheckbox2 = binding.layoutContentLprDetails2.layCheckbox2
        layCheckbox3 = binding.layoutContentLprDetails2.layCheckbox3
        tvVoilationDetailsFocus =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.tvVoilationDetailsFocus
        tvLocationDetailsFocus =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.tvLocationDetailsFocus
        viewLocationDetails =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.viewLocationDetails
        viewVoilationDetails =
            binding.layoutContentLprDetails2.layoutContentLprDetails2InternalNote.viewVoilationDetails
        mTvType1 = binding.layoutContentLprDetails2.tvType1
        mTvType2 = binding.layoutContentLprDetails2.tvType2
        mTvType3 = binding.layoutContentLprDetails2.tvType3
        mCheckboxType1 = binding.layoutContentLprDetails2.checkboxType1
        mCheckboxType2 = binding.layoutContentLprDetails2.checkboxType2
        mCheckboxType3 = binding.layoutContentLprDetails2.checkboxType3
        mTextViewSignName =
            binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.txtPersonSignature
        mTvTicketNumber = binding.layoutContentLprDetails2.tvTicketNumber
        mTvTicketDate = binding.layoutContentLprDetails2.tvTicketDate
        mTvTicketDetailsHide = binding.layoutContentLprDetails2.tvTicketDetailsHide
        tvEnforcementTitle = binding.layoutContentLprDetails2.tvEnforcementTitle
        layTicketDetailsHide = binding.layoutContentLprDetails2.layTicketDetailsHide
        mlinearLayoutCheckBox = binding.layoutContentLprDetails2.linearLayoutCheckBox
        imageViewSignature =
            binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.imgSignature
        appCompatTextViewTicketType = binding.layoutContentLprDetails2.textTicketType
        fabClearButton = binding.fabClear
        mViewPagerBanner =
            binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.layoutContentBanner.pagerBanner
        pagerIndicator =
            binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.layoutContentBanner.viewPagerCountDots
    }

    private fun setupClickListeners() {
        binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.btnPreview.setOnClickListener {
            try {
...
//                }
        ...
        binding.layoutContentLprDetails2.ivCamera.setOnClickListener {
            requestPermission()
        }

        binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.ivCameraBottom.setOnClickListener {
            requestPermission()
        }
        ...
        binding.layoutContentLprDetails2.layoutContentLprDetails2CitationDetails.btnClear.setOnClickListener {
            ClearFileds()
        }
...
//                    mCheckboxType1.setChecked(false);
        ...
        binding.layoutContentLprDetails2.layoutDashboardHeader.imgBack.setOnClickListener {
            deleteImages()
        }
    }
    ...
    private fun init() {
        ...
        addObservers()
        setToolbar()
        val response = getMyDatabase()?.dbDAO?.getCitationLayout()
        sharedPreference.write(
    ...
    private fun getLprVehicleDataFromIntent() {
        ...
        if (intent != null) {
            ...
            if (intent.hasExtra(INTENT_KEY_VEHICLE_INFO)){
                vehicleStickerInfo = intent.getSerializableExtra(INTENT_KEY_VEHICLE_INFO) as VehicleInfoModel?
            }
            ...
            if (intent.getStringExtra("from_scr") != null) {
                ...
                if (intent.getStringExtra("from_scr") == "ticket_details") {
                    ...
                    mainScope.launch {
                        ...
                        if (mTicketActionButtonEvent.equals("VoidReissue", true) && BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)){
                            mLockCitation = "lock"
                        }
                        ...
                        if (mLockCitation.equals("lock", ignoreCase = true)) {
                            setLprLock(lockLprModel, this@LprDetails2Activity, sharedPreference)
                            sharedPreference.write(
...
//                        SharedPrefKey.CITATION_LOCK_PARTIALLY_LOCK,"lock")
            ...
            if (!isIssue) {
                ...
                mViolationCodeCamera = intent.getStringExtra("violation_code_camera")
                ...
                val remarkValue = intent.getStringExtra("timing_record_value_camera")
                if (!remarkValue.isNullOrEmpty() && remarkValue.length > 6) {
                    mTimingRecordRemarkValueCameraFeed = remarkValue
                }
                mbuttonClickScanPage = intent.getIntExtra("SanctionButtonClick",0)
                ...
                if(intent.hasExtra("ExpireYear_CameraViolation")) {
                    val expireYearCameraViolation = intent.getStringExtra("ExpireYear_CameraViolation")
                ...
                if (mVendorName!!.equals("Vigilant",ignoreCase = true)
                    ...
                    if(mTimingImages.get(0).length>200)
                    {
                        ...
                        decodeBase64StringToBitmapAsyn().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, mTimingImages.get(0))
                    }else {
                        try {
            ...
            object : ViewPagerBannerAdapter.ListItemSelectListener {
                override fun onItemClick(position: Int) {
                    ...
                    bannerList!![position]!!.citationImage?.let {
                        mDb!!.dbDAO!!.deleteUnUploadCitationImages(
                            it
                        )
                    }
                    if(bannerList!![position]!!.status == 1)
                    {
                        try {
                            ...
                            {
                                LogUtil.printLog("delete link images",linkImage +" --  "+bannerList!![position]!!.citationImage)
    ...
    private fun callDownloadBitmapApi() {
        if (NetworkCheck.isInternetAvailable(this@LprDetails2Activity)) {
            if (mTimingImages != null && mTimingImages.size > 0) {
                ...
                if(mFromScreen!!.equals("CAMERAFEEDVIOLATION",ignoreCase = true)){
                    downloadBitmapRequest.downloadType = API_CONSTANT_DOWNLOAD_TYPE_RAW_CAMERA_FEED_IMAGES
                }else{
                ...
                try {
                    ...
                    if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_MEMORIALHERMAN,ignoreCase = true)&&
                        ...
                        if(intent!!.hasExtra("CitationCount")){
                            mCitationCountForWarning = intent.getStringExtra("CitationCount").toString()
                            mRemarkItem = ""
                        }
                    }else if(
...
//                                    mAutoComTextViewCode.setText(mApplicationList.get(position).getViolationCode());
            ...
            try {
                if(mAutoCompleteExpiryMonth!=null){
                    ...
                    mExpiryMonth = mIssuranceModel.citationData?.vehicle?.expiration?.getMonthForSetText()
                    mAutoCompleteDate?.setText(
                        mIssuranceModel.citationData?.vehicle?.expiration?.getYearFotSetText()
                    )
                    mExpiryYear = mIssuranceModel.citationData?.vehicle?.expiration?.getYearFotSetText()
                }else {
                    mAutoCompleteDate?.setText(
...
//            && !BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_VOLUSIA,ignoreCase = true)
              && sharedPreference.read(
                    SharedPrefKey.CITATION_LOCK_PARTIALLY_LOCK,"").equals("lock")){
        ...
        Thread {
            mainScope.async {
                try {
                    ...
                    mSelectedCityZone =
                        if(mSelectedCityZone!!.isEmpty()) mWelcomeFormData?.officerZone.toString().toString() else mSelectedCityZone //TODO city Zone CC
...
//                   bannerList!!.removeAt(i)
    ...
    private fun requestPermission() {
            if (PermissionUtils.requestCameraAndStoragePermission(this@LprDetails2Activity)) {
...
//                                requestPermission()
                            ...
                            LogUtil.printLog("Camera", "Captured file is corrupted or empty")
                            LogUtil.printToastMSG(this@LprDetails2Activity, getString(R.string.wrn_lbl_capture_image))
...
//                        ||BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_LAZ_CONJUCTIVE_POINT,ignoreCase = true)){
    ...
    private fun SaveImageMM(finalBitmap: Bitmap?) {
        ...
        if (Environment.getExternalStorageState() != Environment.MEDIA_MOUNTED) {
            LogUtil.printLog("SaveImageMM", "Storage not available for writing")
            return
        }
        val myDir = File(
            Environment.getExternalStorageDirectory().absolutePath,
        ...
        try {
            ...
            if (!success) {
                LogUtil.printLog("SaveImageMM", "Bitmap compression failed")
                file.delete()
                return
            }

            if (file.length() == 0L) {
                LogUtil.printLog("SaveImageMM", "Saved file is 0 bytes, deleting")
                file.delete()
                return
            }
    ...
    private fun SaveImageMMBase64(finalBitmap: Bitmap?) {
        if (finalBitmap == null) {
            LogUtil.printLog("SaveImageMMBase64", "Bitmap is null. Skipping save.")
            LogUtil.printToastMSG(this@LprDetails2Activity,getString(R.string.wrn_lbl_capture_image))
            return
        }

        if (Environment.getExternalStorageState() != Environment.MEDIA_MOUNTED) {
            LogUtil.printLog("SaveImageMMBase64", "External storage not mounted.")
            return
        }
        ...
        val timeStamp = SimpleDateFormat("yyyMMdd_HHmmss_${isImageAsBase64Count}", Locale.US).format(Date())
        val fname = "Image_${timeStamp}_capture.jpg"
        val file = File(myDir, fname)
        ...
        try {
            val out = FileOutputStream(file)
            val compressQuality = if (checkBuildConfigForLprDetails2ForBase64ImageCompress()) 30 else 20
            val isCompressed = finalBitmap.compress(Bitmap.CompressFormat.JPEG, compressQuality, out)

            out.flush()
            out.close()

            if (!isCompressed) {
                LogUtil.printLog("SaveImageMMBase64", "Bitmap compression failed")
                file.delete()
                return
            }

            if (file.length() == 0L) {
                LogUtil.printLog("SaveImageMMBase64", "File saved is 0 bytes. Deleting file.")
                file.delete()
                return
            }
            ...
            LogUtil.printLog("SaveImageMMBase64", "Exception: ${e.message}")
            LogUtil.printToastMSG(this@LprDetails2Activity,getString(R.string.wrn_lbl_capture_image))
            e.printStackTrace()
        }
    }
                    ...
                    mAutoComTextViewState?.post {
                        ...
                        try {
                            ...
                            if(mAutoComTextViewState?.tag != null && mAutoComTextViewState?.tag == "listonly") {
                                setListOnly(
                                    this@LprDetails2Activity, mAutoComTextViewState!!)
                            }
                        } catch (e: java.lang.Exception) {
                            e.printStackTrace()
                        }
            ...
            ioScope.launch {
                ...
                if(mApplicationList != null && mApplicationList.size > 0) {
                    try {
                        Collections.sort(mApplicationList, object : Comparator<DatasetResponse?> {
                            override fun compare(lhs: DatasetResponse?, rhs: DatasetResponse?): Int {
                                return lhs?.remark!!.nullSafety().compareTo(rhs?.remark!!.nullSafety())
                            }
                        })
                    } catch (e: Exception) {
                        e.printStackTrace()
                    ...
                    if(mTimingRecordRemarkValue != null && !TextUtils.isEmpty(
                        ...
                        if(checkBuildConfigForAutoFilledRemark()||
                    ...
                    mEtLocationRemarks?.post {
                        if(mTimingRecordRemarkValue != null && !TextUtils.isEmpty(
                            ...
                            if(checkBuildConfigForAutoFilledRemark()||
                                getSettingFileValuesForRemarkAutoFilledWithElapsedTime()){
                                mEtLocationRemarks?.setText("First Marked time: ".plus(
                                                if(mTimingRecordRemarkValue!=null && !mTimingRecordRemarkValue.equals("null"))
...
//                        mEtLocationRemarks?.setText("Lorem ipsum dolor sit amet, consectetur adip iscing elit.")
                        ...
                        val adapter = ArrayAdapter(this@LprDetails2Activity,
                        ...
                        try {
                            ...
                            if(mEtLocationRemarks?.tag != null && mEtLocationRemarks?.tag == "listonly" &&
                                ...
                                setListOnly(
                                    this@LprDetails2Activity, mEtLocationRemarks!!)
                            }
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
            ...
            ioScope.launch {
                ...
                if (mApplicationList != null && mApplicationList.size > 0) {
                        ...
                        BuildConfig.FLAVOR.equals(DuncanBrandingApp13()))
                    {
                        ...
                        val address = "Marked LOC: "+mBlock.nullSafety()+" "+(if(mSideItem!=null && !mSideItem.equals("null"))mSideItem else "")+" "+ mStreetItem.nullSafety()+" "+
                                mTimingTireStem
                    ...
                    for (i in mApplicationList.indices) {
                        ...
                        try {
                            if (mRemark1Item != null) {
                                if (mApplicationList[i].remark.equals(mRemark1Item,ignoreCase = true
                                    )) {
                                    pos = i
                    ...
                    mEtLocationRemarks1?.post {
                            ...
                            BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_PILOTPITTSBURGPA,ignoreCase = true)))
                        {
                            mEtLocationRemarks1?.setText(mTimingTireStem)
                               ...
                               !mTimingTireStem.equals("Tire Stem :0/0")) {
                            mEtLocationRemarks1?.setText("Marked LOC: "+mBlock.nullSafety()+" "+(if(mSideItem!=null && !mSideItem.equals("null"))mSideItem else "")+" "+ mStreetItem.nullSafety()+" "+
                                    mTimingTireStem)
                            if(!BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_GLENDALE,ignoreCase = true)&&
                                !BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_GLENDALE_POLICE,ignoreCase = true)&&
                                !BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_LAMETRO,ignoreCase = true)&&
    ...
    private fun setDropdownNote() {
        ...
        try {
            if (mEtLocationNotes != null) {
                ioScope.launch {
                    val mApplicationList = Singleton.getDataSetList(DATASET_NOTES_LIST, getMyDatabase())
                    ...
                    if (mApplicationList != null && mApplicationList.size > 0) {
                        try {
                            Collections.sort(mApplicationList, object : Comparator<DatasetResponse?> {
                                override fun compare(lhs: DatasetResponse?, rhs: DatasetResponse?): Int {
                                    return lhs?.note!!.nullSafety().compareTo(rhs?.note!!.nullSafety())
                                }
                            })
                        } catch (e: Exception) {
                            e.printStackTrace()
...
//                            }
    ...
    //                        return  lhs.getModel().compareTo(rhs.getModel());
                        ...
                        if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)&&
                            mBodyStyleItem==null||BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)&&
                            mBodyStyleItem!=null && mBodyStyleItem!!.isEmpty()||
                            BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON,ignoreCase = true)&&
                            mBodyStyleItem==null||BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON,ignoreCase = true)&&
                            mBodyStyleItem!=null && mBodyStyleItem!!.isEmpty()){
                            mBodyStyleItem = sharedPreference.read(SharedPrefKey.LOGIN_HEARING_TIME, "")
                        }
                        ...
                        mAutoComTextViewBodyStyle?.post {
                            if (pos >= 0) {
                                try {
                                    ...
                                    body_style_lookup_code = mApplicationList[pos].body_style_lookup_code
                                } catch (e: Exception) {
                                    e.printStackTrace()
                                }
                            }else if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)||
                                BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON,ignoreCase = true)){
                                mAutoComTextViewBodyStyle!!.setText(sharedPreference.read(SharedPrefKey.LOGIN_HEARING_TIME, ""))
                                mBodyStyleCodeItem = sharedPreference.read(SharedPrefKey.LOGIN_HEARING_TIME, "")
                                body_style_lookup_code = sharedPreference.read(SharedPrefKey.LOGIN_HEARING_TIME, "")
                            }
                            val adapter = ArrayAdapter(
                                this@LprDetails2Activity,
                                R.layout.row_dropdown_menu_popup_item,
                            ...
                            try {
                                ...
                                mAutoComTextViewBodyStyle?.onItemClickListener =
                                    OnItemClickListener { parent, view, position, id -> // mSelectedShiftStat = mApplicationList.get(position);
                                        ...
                                        body_style_lookup_code = mApplicationList[index].body_style_lookup_code
                                    }
                            } catch (e: Exception) {
                                e.printStackTrace()
                            }
                            ...
                            if (mAutoComTextViewBodyStyle?.tag != null && mAutoComTextViewBodyStyle?.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mAutoComTextViewBodyStyle!!)
                            }
                        }
                    }
                }
                            ...
                            mTvOfficerModel?.post {
                                ...
                                try {
                                    ...
                                    if (mTvOfficerModel?.tag != null && mTvOfficerModel?.tag == "listonly") {
                                        setListOnly(this@LprDetails2Activity, mTvOfficerModel!!)
                                    }
                                } catch (e: Exception) {
                                }
                            }
...
//                                                        parent.getItemAtPosition(position)
                            ...
                            if (mTvOfficerMake?.tag != null && mTvOfficerMake?.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mTvOfficerMake!!)
                            }
                        } catch (e: Exception) {
                        }
                    }
...
//                        }
                            ...
                            if (mTvOfficerColor?.tag != null && mTvOfficerColor?.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mTvOfficerColor!!)
                            }
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
...
private fun setDropdownDecalYear() {
    ...
    ioScope.launch {
        if (mAutoComTextViewDecalYear != null) {
            val mApplicationList = Singleton.getDataSetList(DATASET_DECAL_YEAR_LIST, getMyDatabase())
                ...
                mAutoComTextViewDecalYear?.post {
                    ...
                    try {
                        ...
                        if (mAutoComTextViewDecalYear?.tag != null && mAutoComTextViewDecalYear?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewDecalYear!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
private fun setDropdownStreet() {
    ...
    ioScope.launch {
        if(mAutoComTextViewStreet == null) return@launch
            ...
            val fullStreetList  = Singleton.getDataSetList(DATASET_STREET_LIST, getMyDatabase()) ?: emptyList()
...
//        val mApplicationList = mDatasetStreetList
                ...
                if (mApplicationList.isEmpty()) {
                    LogUtil.printLog("Street Filter", "No matching lot found, using full list as fallback.")
                ...
                mAutoComTextViewStreet?.post {
                    ...
                    try {
                        ...
                        if (mAutoComTextViewStreet?.tag != null && mAutoComTextViewStreet?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewStreet!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
                    ...
                    mTvBeat?.post {
                        ...
                        try {
                            ...
                            if (mTvBeat!!.tag != null && mTvBeat!!.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mTvBeat!!)
                            }
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
    ...
    ioScope.launch {
        if (mAutoComTextViewMeterName != null) {
            ...
            mainScope?.launch {
                ...
                val meterAdapter = AutoCompleteAdapter(mContext!!,
                    ...
                    object : AutoCompleteAdapter.ListItemSelectListener {
                        override fun onItemClick(position: Int, meterObject: DatasetResponse) {
                            ...
                            try {
                                ...
                                mAutoComTextViewDirection?.setText(meterObject?.direction.nullSafety(""))
                                ...
                                if (meterObject?.mPbcZone != null) {
                                    mAutoComTextViewPBCZone?.setText(meterObject.mPbcZone.nullSafety(""))
                                }
//                            }
                            } catch (e: Exception) {
                                e.printStackTrace()
...
private fun setDropdownBlock() {
    ...
    if (mAutoComTextViewBlock != null) {
        ioScope.launch {
            ...
            val fullBlockList  = Singleton.getDataSetList(DATASET_BLOCK_LIST, getMyDatabase()) ?: emptyList()
            val mApplicationList: MutableList<DatasetResponse> = ArrayList()
//        val mApplicationList = mDatasetStreetList
            mApplicationList.addAll(
                fullBlockList!!.filter { it.zoneName.equals(selectedCityZone, ignoreCase = true) }
            )
                ...
                mAutoComTextViewBlock?.post {
                    ...
                    try {
                        ...
                        if (mAutoComTextViewBlock?.tag != null && mAutoComTextViewBlock?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewBlock!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
//                                        }
                            ...
                            if (mAutoComTextViewZone?.tag != null && mAutoComTextViewZone?.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mAutoComTextViewZone!!)
                            }
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
...
//                                mAutoComTextViewMeterName!!.setText(mAutoComTextViewPBCZone!!.text.toString())
                        ...
                        if (mAutoComTextViewPBCZone?.tag != null && mAutoComTextViewPBCZone?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewPBCZone!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
//                    }
                    ...
                    try {
                        ...
                        if (mAutoComTextViewLocation?.tag != null && mAutoComTextViewLocation?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewLocation!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
//                mDropdownList[i] = String.valueOf(mApplicationList.get(i).getLot());//TODO TIN
                    ...
                    try {
                        if (mLotItem != null) {
                            if (mApplicationList[i].lot != null && mApplicationList[i].lot!!.isNotEmpty() &&
                                ...
                                ||mLotItem!!.isNotEmpty() && mApplicationList[i].location != null && mApplicationList[i].location!!.isNotEmpty() &&
                                    mApplicationList[i].location.equals(mWelcomeFormData!!.lot, ignoreCase = true)) {
                                pos = i
                                try {
                                    mViolationExtraAmount = mApplicationList[i].violation
                                        ?.takeIf { it.isNotBlank() }   // Only take if not blank
                ...
                mAutoComTextViewLot?.post {
                    if (pos >= 0) {
                        ...
                        if(!BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_DALLAS,ignoreCase = true)) {
                        ...
                        setDropdownDirection()
                            try {
                                mLotBranchId = mApplicationList[pos].lotBranchId
                                    ?.takeIf { it.isNotBlank() }   // Only take if not blank
                        ...
                        try {
                                mLotlookupCode = mApplicationList[pos].lotLookupCode
                                    ?.takeIf { it.isNotBlank() }   // Only take if not blank
                                    ?.toString()         // Convert safely to Double
                                    ?: ""
                            } catch (e: Exception) {
...
//                                val separated = currentString.split(" ").toTypedArray()
                                ...
                                try {
                                    val isCartaFlavor = BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA, ignoreCase = true)
                                    val item = mViolationListSelectedItem

                                    mViolationExtraAmount = mApplicationList[index].violation
                                    ...
                                    mApplicationList[index].agency_name?.takeIf { it.isNotEmpty() }?.let {
                                        mTvAgency?.setText(it)
                                    }
                                } catch (e: Exception) {
                                    e.printStackTrace()
                                ...
                                try {
                                    mLotBranchId = mApplicationList[index].lotBranchId
                                        ?.takeIf { it.isNotBlank() }   // Only take if not blank
                                        ?.toString()         // Convert safely to Double
                                        ?: ""
                                } catch (e: Exception) {
                                ...
                                try {
                                    mLotlookupCode = mApplicationList[index].lotLookupCode
                                        ?.takeIf { it.isNotBlank() }   // Only take if not blank
                                        ?.toString()         // Convert safely to Double
                                        ?: ""
                                } catch (e: Exception) {
                        ...
                        if (mAutoComTextViewLot?.tag != null && mAutoComTextViewLot?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewLot!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
                ...
                mAutoComTextViewSide?.post {
                    ...
                    try {
                        ...
                        if (mAutoComTextViewSide?.tag != null && mAutoComTextViewSide?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewSide!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
                ...
                mAutoComTextViewDirection?.post {
                    ...
                    try {
                        ...
                        if (mAutoComTextViewDirection?.tag != null && mAutoComTextViewDirection?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewDirection!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
private fun setDropdownVinNumber() {
    ...
    }else if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_SOUTH_LAKE,true)||
            ...
            mAutoCompleteDate?.post {
                    ...
                    try {
                        ...
                        if (mAutoCompleteDate?.tag != null && mAutoCompleteDate?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoCompleteDate!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
...
//                            mAutoCompleteExpiryMonth?.setAdapter<ArrayAdapter<String?>>(adapter)
                        ...
                        mAutoCompleteExpiryMonth?.onItemClickListener =
                            OnItemClickListener { parent, view, position, id -> // mSelectedShiftStat = mApplicationList.get(position);
                                ...
                                val selectedIndex = months.indexOfFirst { it.equals(selectedMonth, ignoreCase = true) }
                        ...
                        if (mAutoCompleteExpiryMonth?.tag != null && mAutoCompleteExpiryMonth?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoCompleteExpiryMonth!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
    ...
    private fun setDropdownVioType() {
       hideSoftKeyboard(this@LprDetails2Activity)
        if (mAutoComTextViewVioType != null) {
            val mApplicationList = Singleton.getDataSetList(DATASET_VIO_LIST, getMyDatabase())
            var mViolationList =
                Singleton.getDataSetList(DATASET_VIOLATION_LIST, getMyDatabase())
                ...
                if (mApplicationList != null && mApplicationList.size > 0) {
                    ...
                    mAutoComTextViewVioType?.post {
                        if (pos >= 0) {
                            ...
                            if(mEtMarkTime!=null && mViolationListSelectedItem!!.mMarkTime.equals("1")) {
                        ...
                        try {
                            ...
                            mAutoComTextViewVioType?.onItemClickListener =
                                OnItemClickListener { parent, view, index, id ->
                                    ioScope.launch {
                                        ...
                                        try {
                                            mApplicationList?.get(position)?.mvio_type_code?.let { mAutoComTextViewVioTypeCode?.setText(it.toString()) }
                                        } catch (e: Exception) {
                                            e.printStackTrace()
                                        }
                                        try {
                                            mAutoComTextViewVioTypeDescription?.setText(mApplicationList?.get(position)?.mvio_type_description)
                                        } catch (e: Exception) {
                                            e.printStackTrace()
                                        }
                                        try {
                                            mAutoComTextViewVioType?.setText(mApplicationList?.get(position)?.mvio_type)
                                        } catch (e: Exception) {
                                            e.printStackTrace()
                                        }
                                        ...
                                        for (violation in mViolationList!!) {
                                            if (violation.mvio_type != null && vioTYpe != null) {
                                                if (violation.mvio_type != null && violation.mvio_type.equals(
                                                        vioTYpe, true )&& (selectedZoneCode != null && selectedZoneCode!!.isNotEmpty()&& violation.mZoneId.equals(
                                                        selectedZoneCode, true )||
                                                            mAutoComTextViewZone != null && !mAutoComTextViewZone?.text?.toString()?.isNullOrEmpty()!! && violation.mZoneId.equals(
                            ...
                            if (mAutoComTextViewVioType?.tag != null && mAutoComTextViewVioType?.tag == "listonly") {
                                setListOnly(this@LprDetails2Activity, mAutoComTextViewVioType!!)
                            }
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
...
//                        mDropdownList2[i] = mApplicationList[i].violationDescription.toString()
                    ...
                    if ((!isMatched && mAutoComTextViewAbbrCode != null && !TextUtils.isEmpty(
                        ...
                        mApplicationList[i].mSanctionsSticker!=null &&
                        mbuttonClickScanPage!! >0&&
                        mApplicationList[i].mSanctionsSticker==mbuttonClickScanPage||
                        mViolationCodeCamera!=null &&
                        mApplicationList[i].violationCode.equals(mViolationCodeCamera)){
                        pos = i
                        isMatched = true
                        /***
                         ...
                         */
                        try {
                            isOverTimeParkingViolationForTimeLimit = mApplicationList[pos].timelimitVio
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
                         ...
                         */
                        try {
                            amountDays = if(mApplicationList[pos].mAmountDays!=null && mApplicationList[pos].mAmountDays!!.isNotEmpty())mApplicationList[pos].mAmountDays!!.toInt() else amountDaysCitationForm
                            lateFineDays = if(mApplicationList[pos].mLateFineDays!=null && mApplicationList[pos].mLateFineDays!!.isNotEmpty())mApplicationList[pos].mLateFineDays!!.toInt() else lateFineDaysCitationForm
                            lateFine15Days = if(mApplicationList[pos].mDue15DateDays!=null && mApplicationList[pos].mDue15DateDays!!.isNotEmpty())mApplicationList[pos].mDue15DateDays!!.toInt() else lateFine15DaysCitationForm
                            lateFine30Days = if(mApplicationList[pos].mDue30DateDays!=null && mApplicationList[pos].mDue30DateDays!!.isNotEmpty())mApplicationList[pos].mDue30DateDays!!.toInt() else lateFine30Days
                            mZoneMandatoryForViolationCode = if(mApplicationList[pos].mZoneMandatory!=null && mApplicationList[pos].mZoneMandatory!!.isNotEmpty())mApplicationList[pos].mZoneMandatory!! else "NO"
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
                        /**
                         ...
                         */
                        try {
                            sanctionsType = if(mApplicationList[pos].mSanctionsSticker!=null && mApplicationList[pos].mSanctionsSticker!!>0)mApplicationList[pos].mSanctionsSticker!!.toInt() else 0
                        } catch (e: Exception) {
                            e.printStackTrace()
                        }
                    }
                ...
                mAutoComTextViewAbbrCode?.post {
                    ...
                    try {
                            ...
                            OnItemClickListener { parent, view, index, id ->
                                ioScope.launch {
                                    ...
                                    mainScope.async {
                                        ...
                                        hideSoftKeyboard(this@LprDetails2Activity)
                                        setViolationBaseData(mViolationListSelectedItem,
                                            position)
                                        try {
                                        ...
                                        try {
                                           isOverTimeParkingViolationForTimeLimit = mApplicationList[position].timelimitVio
                                        } catch (e: Exception) {
                                            e.printStackTrace()
                                        }
                                        try {
                                            mZoneMandatoryForViolationCode = mApplicationList[position].mZoneMandatory!!
                                        } catch (e: Exception) {
                                            e.printStackTrace()
                                        }
                                    }
                                    ...
                                    if (mLockCitation.equals("lock", ignoreCase = true)) {
                                        lockLprModel?.apply {
                                            ...
                                            ticketCategory = API_CONSTANT_TICKET_CATEGORY_CITATION
                                        }?.let { model ->
                                            setLprLock(model, this@LprDetails2Activity, sharedPreference)
                                     ...
                                     */
                                    try {
                                        amountDays = if(mApplicationList[position].mAmountDays!=null && mApplicationList[position].mAmountDays!!.isNotEmpty())mApplicationList[position].mAmountDays!!.toInt() else amountDaysCitationForm
                                        lateFineDays = if(mApplicationList[position].mLateFineDays!=null && mApplicationList[position].mLateFineDays!!.isNotEmpty())mApplicationList[position].mLateFineDays!!.toInt() else lateFineDaysCitationForm
                                        lateFine15Days = if(mApplicationList[position].mDue15DateDays!=null && mApplicationList[position].mDue15DateDays!!.isNotEmpty())mApplicationList[position].mDue15DateDays!!.toInt() else lateFine15DaysCitationForm
                                        lateFine30Days = if(mApplicationList[position].mDue30DateDays!=null && mApplicationList[position].mDue30DateDays!!.isNotEmpty())mApplicationList[position].mDue30DateDays!!.toInt() else lateFine30Days
                                        AppUtils.autoFilledRemarkBasedOnExpiryMonthAndYear(this@LprDetails2Activity
                                            ,mEtLocationRemarks,mAutoCompleteExpiryMonth,mAutoCompleteDate)
                                    } catch (e: Exception) {
                                        e.printStackTrace()
                                    }
                                     ...
                                     */
                                    try {
                                        sanctionsType = if(mApplicationList[position].mSanctionsSticker!=null && mApplicationList[position].mSanctionsSticker!!>0)mApplicationList[position].mSanctionsSticker!!.toInt() else 0
                                    } catch (e: Exception) {
                                        e.printStackTrace()
                                    }
                                }
                        ...
                        if (mAutoComTextViewAbbrCode?.tag != null && mAutoComTextViewAbbrCode?.tag == "listonly") {
                            setListOnly(this@LprDetails2Activity, mAutoComTextViewAbbrCode!!)
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                    }
            ...
            if (mCheckboxType1 != null && mCheckboxType1.tag == "Amount0" ||
                    ...
                    try {
                        if (mAutoComTextViewAmount != null) {
                            if (fineCalculatedField == API_CONSTANT_CALCULATED_FIELD_ESCALATED &&
                                ...
                                if(mAutoComTextViewZone!=null &&
                                    mAutoComTextViewZone?.text.toString().equals("OFF STREET",ignoreCase = true))
                                {
                                    if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                        mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED")||
                                        BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                        mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED PAID")){
                                        mAutoComTextViewAmount?.setAmount(dollerSign,
                        ...
                        if (mAutoComTextViewAmountDueDate != null) {
                                ...
                                mAutoComTextViewZone?.text.toString().equals("OFF STREET",ignoreCase = true))
                            {
                                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    ...
                                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED PAID")){
                                    mAutoComTextViewAmountDueDate?.setAmount(dollerSign,
                        ...
                        if (AutoComTextViewDueDate != null) {
                                ...
                                mAutoComTextViewZone?.text.toString().equals("OFF STREET",ignoreCase = true))
                            {
                                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    ...
                                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED PAID")){
                                    AutoComTextViewDueDate?.setAmount(dollerSign,
                        ...
                        if (AutoComTextViewDueDate30 != null) {
                                ...
                                mAutoComTextViewZone?.text.toString().equals("OFF STREET",ignoreCase = true))
                            {
                                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    ...
                                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED PAID")){
                                    AutoComTextViewDueDate30?.setAmount(dollerSign,
                        ...
                        if (AutoComTextViewDueDate45 != null) {
                                ...
                                mAutoComTextViewZone?.text.toString().equals("OFF STREET",ignoreCase = true))
                            {
                                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    ...
                                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA,ignoreCase = true)&&
                                    mAutoComTextViewAbbrCode!!.text!!.toString().equals("ILLEGAL HANDICAPPED PAID")){
                                    AutoComTextViewDueDate45?.setAmount(dollerSign,
                ...
                try {
                    ...
                    if(AutoComTextViewTotalDue!=null){
                        AutoComTextViewTotalDue?.setAmount(dollerSign,
...
private fun saveCitationIssurance(mLatestCitation: CitationBookletModel?) {
    ...
    class SaveCitationIssuranceTask : AsyncTask<Void?, Int?, String?>() {
        override fun doInBackground(vararg voids: Void?): String? {
            ...
            mBookletStatus = getMyDatabase()!!.dbDAO!!.getBookletStatus(mLatestCitation!!.citationBooklet)
            ...
            if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)||
                ...
                sharedPreference.write(
                    SharedPrefKey.CITATION_NUMBER_FOR_PRINT_X, mPrintOrderMap["citNumber"]!!.printAxisX)

                sharedPreference.write(
                    SharedPrefKey.CITATION_NUMBER_FOR_PRINT_Y, mPrintOrderMap["citNumber"]!!.printAxisY)
            ...
            try {
                mIssModel.code2010 = if(code2010!=null && code2010.isNotEmpty()) code2010 else "2010"
            ...
            try {
                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_HARTFORD, true)) {
                    ...
                    mIssModel.hearingDate = AppUtils.hearingDateAfterThresholdDifferenceDays(this@LprDetails2Activity, HEARING_DATE_DAY_DIFFERENCE_THRESHOLD)
                    ...
                    mIssModel.hearingDate = if (hearingThresholdDay != null && hearingThresholdDay > 0) {
                        AppUtils.hearingDateAfterThresholdDay(this@LprDetails2Activity,hearingThresholdDay)
                    } else {
                        ""
                    }
                }
            ...
            officerModel.badgeId = if(mTvBadgeId!=null) mTvBadgeId!!.text.toString() else "" // mWelcomeFormData!!.officerBadgeId
...
//                officerModel.beat = mWelcomeFormData!!.officerBeatName
            ...
            if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CARTA, ignoreCase = true)) {
                officerModel.agency = AppUtils.removeSpecialCharacterFromString(mTvAgency!!.text.toString())
            }else if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS, ignoreCase = true)||
                BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON, ignoreCase = true)||
                ...
                officerModel.agency = (if(mTvAgency!=null && mTvAgency!!.text.toString().isNotEmpty()) mTvAgency!!.text.toString() else mWelcomeFormData!!.agency!!)
            }else {
                officerModel.agency = AppUtils.removeSpecialCharacterFromString(if(mTvAgency!=null && mTvAgency!!.text.toString().isNotEmpty()) mTvAgency!!.text.toString() else mWelcomeFormData!!.agency!!)
            }
...
//                    officerModel.setShift(mWelcomeFormData.getShift());
            ...
            try {
                if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_CITYOFSANDIEGO,true)||
                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_STORMWATER_DIVISION,true)){
                    officerModel.observationTime = if(mEtMarkTime!=null && mEtMarkTime?.visibility == View.VISIBLE) mEtMarkTime!!.text.toString() else ""
                }else if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_GREENBURGH_NY,true)||
                    BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_DEER_FIELD_BEACH_FL,true)){
                    officerModel.observationTime =  AppUtils.getCurrentDateForObserveTimeFieldForGreenburgh()
                }else {
...
//                vehicleModel.model = AppUtils.removeSpecialCharacterFromString(mSelectedModel!!)
            val finalModel = if (!mSelectedModel.isNullOrBlank() &&
                mSelectedModel.equals(mTvOfficerModel?.text?.toString(), ignoreCase = true)
            ) {
                mSelectedModel
            } else {
...
//                }
            ...
            try {
                mAutoCompleteDate?.let {
                    if(mAutoCompleteExpiryMonth!=null){
                        //TODO JANAK DATE
                        vehicleModel.expiration = mExpiryMonth.toString().trim().verifyAndConvertMonth()+"/"+mExpiryYear.toString().trim().verifyAndConvertYear()
                    }else {
            ...
            try {
                ...
                if (mSendStateEmptyForFullVinNumberAndCopyLast8DigitVinForLpr.equals("YES")) {
                    if (mAutoComTextViewVinNum != null &&
                        (!mApplicationVinList.any { it.direction == inputTextForVin })
            ...
            try {
                mBodyStyleCodeItem?.let {
                    vehicleModel.bodyStyle = AppUtils.removeSpecialCharacterFromString(mBodyStyleCodeItem!!)
                    if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)||
                        BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON,ignoreCase = true))
                    {
            ...
            try {
                mAutoComTextViewLicensePlate?.let {
                    vehicleModel.licensePlate =
                        AppUtils.removeSpecialCharacterFromString(mAutoComTextViewLicensePlate?.editableText.toString().trim())
...
//                    locationModel.setSide(mAutoComTextViewSide.getEditableText().toString().trim());
            ...
            try {
                mAutoComTextViewMeterName?.let {
                    locationModel.meterName = mAutoComTextViewMeterName?.editableText.toString().trim()
            ...
            try {
                locationModel.spaceName =
                    ...
                    ) AppUtils.removeSpecialCharacterFromString(mAutoConTextViewSpace?.editableText.toString().trim())
                    else ""
...
//                    mAutoComTextViewZone?.let {
                    ...
                    locationModel.pcbZone =
                        AppUtils.removeSpecialCharacterFromString(mAutoComTextViewPBCZone?.editableText.toString().trim())
...
//                    mAutoComTextViewPBCZone?.let {
            ...
            voilationModel.violationCode = if(mViolationListSelectedItem?.violation!=null && mViolationListSelectedItem?.violation!!.isNotEmpty())mViolationListSelectedItem?.violation.nullSafety() else mAutoComTextViewAbbrCode!!.text.toString()
            voilationModel.code = if(mViolationListSelectedItem?.violationCode!=null && mViolationListSelectedItem?.violationCode!!.isNotEmpty()) mViolationListSelectedItem?.violationCode.nullSafety() else mAutoComTextViewCode!!.text.toString()
            voilationModel.timeLimitVio = if(mVendorName!!.equals("Vigilant",ignoreCase = true)) "0" else if(mViolationListSelectedItem?.timelimitVio!=null && mViolationListSelectedItem?.timelimitVio!!.isNotEmpty()) mViolationListSelectedItem?.timelimitVio.nullSafety() else "0"
...
//                    voilationModel.setStatus_due_date_45(false);
            ...
            try {
                mAutoComTextViewVioType?.let {
                    voilationModel.vioType =
                        mAutoComTextViewVioType?.editableText.toString()
                            .trim()
            ...
            try {
                mAutoComTextViewVioTypeCode?.let {
                    voilationModel.vioTypeCode = mAutoComTextViewVioTypeCode?.editableText.toString()
                            .trim()
            ...
            try {
                mAutoComTextViewVioTypeDescription?.let {
                    voilationModel.vioTypeDescription = mAutoComTextViewVioTypeDescription?.editableText.toString()
                            .trim()
...
//                    voilationModel.setLocationDescr(""); voilationModel.setStatus_location_descr(false);
            ...
            try {
                ...
                mIssModel.locationBottomText = if (mPrintOrderMap.containsKey("BottomLabelPrint")) mPrintOrderMap["BottomLabelPrint"]!!.labelName else ""
...
//            val mIntent = Intent(this@LprDetails2Activity, LprPreviewActivity::class.java)
...
//                                getString(R.string.scr_lbl_ticket_number))
                    ...
                    mPrintOrderMap["citNumber"] = PrintLayoutModel(number,1, layoutNumber,
                            mCitationLayout!![iCit].fields!![0].repr,mCitationLayout!![iCit].fields!![0].mPositionXYFont)
...
//                        appCompatTextViewTicketNumberTitle!!.setTag(mCitationLayout!![iCit].fields!![0].mDataTypeValidation)
                ...
                if (mHeaderSize == 2) {
                    ...
                    mPrintOrderMap["timestamPrint"] = PrintLayoutModel(number,1, layoutNumber,mCitationLayout!![iCit].fields!![1].repr,
                    ...
                    val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(0)?.mDisplayColumn
...
//                        mPrintOrderMap["citNumber"] = PrintLayoutModel(number2,1, layoutNumber2,getString(R.string.scr_lbl_ticket_number))
                    mPrintOrderMap["citNumber"] = PrintLayoutModel(number2,1, layoutNumber2,mCitationLayout!![iCit].fields!![0].repr,
                        mCitationLayout!![iCit].fields!![0].mPositionXYFont,columnSize)
                    appCompatTextViewTicketNumberTitle!!.setText(mCitationLayout!![iCit].fields!![0].repr)
                    layTicketNum.visibility = View.VISIBLE
            ...
            if (mCitationLayout!![iCit].component.equals("Citation Type", ignoreCase = true)
                ...
                if (mHeaderSize == 1) {
                    ...
                    mPrintOrderMap["warningPrint"] = PrintLayoutModel(number,1, layoutNumber,mCitationLayout!![iCit].fields!![0].repr,
                ...
                if (mHeaderSize == 2) {
                    ...
                    mPrintOrderMap["bootPrint"] = PrintLayoutModel(number2,1, layoutNumber2,mCitationLayout!![iCit].fields!![1].repr,
                        mCitationLayout!![iCit].fields!![1].mPositionXYFont)
                    layCheckbox3.visibility = View.INVISIBLE
                }
                if (mHeaderSize == 3) {
                    ...
                    mPrintOrderMap["bootPrint"] = PrintLayoutModel(number2,1, layoutNumber2,mCitationLayout!![iCit].fields!![0].repr,
                        mCitationLayout!![iCit].fields!![0].mPositionXYFont)
                    val number3: Double =
                            if (mCitationLayout!![iCit].fields!![0].mPrintLayoutOrder != null) if (!TextUtils.isEmpty(
                                            mCitationLayout!![iCit].fields!![0].mPrintLayoutOrder
                    ...
                    mPrintOrderMap["bootPrint"] = PrintLayoutModel(number3,1, layoutNumber3,mCitationLayout!![iCit].fields!![0].repr,
                        mCitationLayout!![iCit].fields!![0].mPositionXYFont)
                }
            }
            if (mCitationLayout!![iCit].component.equals("Officer", ignoreCase = true)) {
                ...
                for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                    if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                        ...
                        val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                            ?.takeIf { !TextUtils.isEmpty(it) }
                            ?.toIntOrNull() ?: 1
                        ...
                        mPrintOrderMap["officernamePrint"] =
                            PrintLayoutModel(printOrder,column,layoutOrder,mCitationLayout!![iCit].fields!![iOff].repr,
                                mCitationLayout!![iCit].fields!![iOff].mPositionXYFont,columnSize)
                        ...
                        val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                            ?.takeIf { !TextUtils.isEmpty(it) }
                            ?.toIntOrNull() ?: 1
                        mPrintOrderMap["badgePrint"] = PrintLayoutModel(printOrder,column, layoutOrder,
                        ...
                        mPrintOrderMap["beatPrint"] = PrintLayoutModel(printOrder,column, layoutOrder,
                                mCitationLayout!![iCit].fields!![iOff].repr,
                            mCitationLayout!![iCit].fields!![iOff].mPositionXYFont,columnSize)
                        ...
                        val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                            ?.takeIf { !TextUtils.isEmpty(it) }
                            ?.toIntOrNull() ?: 1
                        mPrintOrderMap["squadPrint"] = PrintLayoutModel(printOrder,column, layoutOrder,
                                mCitationLayout!![iCit].fields!![iOff].repr,
                            mCitationLayout!![iCit].fields!![iOff].mPositionXYFont,columnSize)
                        ...
                        val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                            ?.takeIf { !TextUtils.isEmpty(it) }
                            ?.toIntOrNull() ?: 1
                        mPrintOrderMap["zonePrint"] = PrintLayoutModel(printOrder,column,layoutOrder,
                                mCitationLayout!![iCit].fields!![iOff].repr,
                            mCitationLayout!![iCit].fields!![iOff].mPositionXYFont,columnSize)
                ...
                if (mCitationLayout!![iCit].component.equals("Vehicle", ignoreCase = true)) {
                    ...
                    for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                        if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mTvOfficerMake!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mTvOfficerModel!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mTvOfficerColor!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            try {
//                                    getStateAndCamera2Setting()
                                setFieldCaps(this@LprDetails2Activity, mAutoComTextViewState!!)
                            } catch (e: Exception) {
                                e.printStackTrace()
                            }
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            if (BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_GLENDALE,
                                ...
                                ||BuildConfig.FLAVOR.equals(
                                    ...
                                    ignoreCase = true)||BuildConfig.FLAVOR.equals(
...
//                                if (checkBuildConfigForCitationFormVinNumberNotCopyInLprField()) {
                            ...
                            if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_ORLEANS,ignoreCase = true)||
                                BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_BOSTON,ignoreCase = true)) {
                                mAutoComTextViewDecalNum?.setText(sharedPreference.read(SharedPrefKey.LOGIN_HEARING_DATE, ""))
                ...
                if (mCitationLayout!![iCit].component.equals("Location", ignoreCase = true)) {
                    ...
                    for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                        if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mAutoComTextViewStreet!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewBlock!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mAutoComTextViewDirection!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewSide!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoConTextViewSpace!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                                "zone",ignoreCase = true)) {
                            zonePrint = mCitationLayout!![iCit].fields!![iOff].print!!
                            val printOrder: Double =
                            ...
                            setFieldCaps(this@LprDetails2Activity, mAutoComTextViewZone!!)
                            setDropdownZone(mSelectedCityZone)
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewZone!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mAutoComTextViewPBCZone!!)
                            setDropdownPBCZone(mPBCZone)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewLot!!)
                        } else {
                            try {
                ...
                if (mCitationLayout!![iCit].component.equals("Violation", ignoreCase = true)) {
                    ...
                    for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                        if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            setFieldCaps(this@LprDetails2Activity, mAutoComTextViewAbbrCode!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewCode!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mEtLocationDescr!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            if(!mCitationLayout!![iCit].fields!![iOff].mCalculatedField!!.isEmpty()){
                                amountDaysCitationForm = mCitationLayout!![iCit].fields!![iOff].mCalculatedField?.toInt()!!
                            }
                            val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                                ?.takeIf { !TextUtils.isEmpty(it) }
                                ?.toIntOrNull() ?: 1
                            ...
                            if(!mCitationLayout!![iCit].fields!![iOff].mCalculatedField!!.isEmpty()){
                                lateFineDaysCitationForm = mCitationLayout!![iCit].fields!![iOff].mCalculatedField?.toInt()!!
                            }
...
//                                else 0
                            ...
                            if(!mCitationLayout!![iCit].fields!![iOff].mCalculatedField!!.isEmpty()){
                                lateFine15DaysCitationForm = mCitationLayout!![iCit].fields!![iOff].mCalculatedField?.toInt()!!
                            }
                            val printOrder: Double =
                                if (mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder != null) if (!TextUtils.isEmpty(
                                        mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder
                            ...
                            if(!mCitationLayout!![iCit].fields!![iOff].mCalculatedField!!.isEmpty()){
                                lateFine30Days = mCitationLayout!![iCit].fields!![iOff].mCalculatedField?.toInt()!!
                            }
                            val printOrder: Double =
                                if (mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder != null) if (!TextUtils.isEmpty(
                                        mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder
                            ...
                            if(!mCitationLayout!![iCit].fields!![iOff].mCalculatedField!!.isEmpty()){
                                lateFine45Days = mCitationLayout!![iCit].fields!![iOff].mCalculatedField?.toInt()!!
                            }
                            val printOrder: Double =
                                if (mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder != null) if (!TextUtils.isEmpty(
                                        mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder
                            ...
                            vio_type_codePrint[0] = mCitationLayout!![iCit].fields!![iOff].print!!

                            val printOrder = mCitationLayout?.getOrNull(iCit)
                                ?.fields?.getOrNull(iOff)
                                ?.mPrintLayoutOrder.safeDoubleFromLayout()
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewVioTypeCode!!)
                        }  else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                                "vio_type_description",ignoreCase = true)) {
                            vio_type_descriptionPrint[0] = mCitationLayout!![iCit].fields!![iOff].print!!
//                            val printOrder: Double =
//                                if (mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder != null) if (!TextUtils.isEmpty(
//                                        mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder
//                                    )) if(mCitationLayout!![iCit].fields!![iOff].mPrintLayoutOrder!!.contains("#"))
...
//                                    .toDouble() else "0".toDouble() else "0".toDouble()
                            ...
                            val columnSize: Int = mCitationLayout?.get(iCit)?.fields?.get(iOff)?.mDisplayColumn
                                ?.takeIf { !TextUtils.isEmpty(it) }
                                ?.toIntOrNull() ?: 1
                            mPrintOrderMap["vio_type_description"] =
                                PrintLayoutModel(printOrder,column, layoutOrder,mCitationLayout!![iCit].fields!![iOff].repr,
                                    mCitationLayout!![iCit].fields!![iOff].mPositionXYFont,columnSize)
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewVioTypeDescription!!)
                        }  else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
...
//                                    .toDouble() else "0".toDouble() else "0".toDouble()
                            ...
                            Util.setFieldCaps(this@LprDetails2Activity, mAutoComTextViewVioType!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                ...
                if (mCitationLayout!![iCit].component.equals("Comments", ignoreCase = true)) {
                    for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                        if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            MaxCharcterLimitForComment =if (mCitationLayout!![iCit].fields!![iOff].mMaxLength != null) if (!TextUtils.isEmpty(
                            ...
                            mEtLocationRemarks?.inputType =
                                InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS
                            Util.setFieldCaps(this@LprDetails2Activity, mEtLocationRemarks!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            mEtLocationRemarks1?.inputType =
                                InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS
                            Util.setFieldCaps(this@LprDetails2Activity, mEtLocationRemarks1!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                            ...
                            mEtLocationRemarks2?.inputType =
                                InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS
                            Util.setFieldCaps(this@LprDetails2Activity, mEtLocationRemarks2!!)
                        } else if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                ...
                for (iOff in mCitationLayout!![iCit].fields!!.indices) {
                    ...
                    if (mCitationLayout!![iCit].fields!![iOff].name.equals(
                        ...
                        try {
                            ...
                            val hearingThresholdDayValue = mCitationLayout!![iCit].fields!![iOff].mCalculatedField.nullSafety()
                            ...
                            if(mCitationLayout!![iCit].fields!![iOff].tag.equals("dropdown")||
                                mCitationLayout!![iCit].fields!![iOff].tag.equals("editview")) {
                                    mEtMarkTime?.setOnClickListener {
                                        AppUtils.hideSoftKeyboard(this@LprDetails2Activity)
                                        openTimePicker(mEtMarkTime, this@LprDetails2Activity,Constants.TIME_FORMAT)
                                    }
                                }else{
                                if(mEtMarkTime!=null) {
            ...
            for (citationLayout in mCitationLayout!!) {
                        ...
                        if (citationLayout.fields!![iOff].name.equals(
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                                    ...
                                    showKeyboard(this@LprDetails2Activity)
                                    printToastMSGForErrorWarning(
                                        applicationContext,
                ...
                if (citationLayout.component.equals("Vehicle", ignoreCase = true)) {
                    for (iOff in citationLayout.fields!!.indices) {
                        if (citationLayout.fields!![iOff].name.equals(
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                                    ...
                                    if (mModelList != null && mModelList.size > 0) {
                                        ...
                                        showKeyboard(this@LprDetails2Activity)
                                        printToastMSGForErrorWarning(
                                            applicationContext, getString(R.string.val_msg_please_enter_model))
                                        return false
                                    }
                                }
                            }
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                                    ...
                                    //AppUtils.showKeyboard(LprDetails2Activity.this);
                                    printToastMSGForErrorWarning(applicationContext,
                                        getString(R.string.val_msg_please_enter_expiry_date))
                                    return false
                                }
                            }
                            if(BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_OXFORD,ignoreCase = true) && !ExpiryDateTextWatcher.validateExpiryDate(mAutoCompleteDate!!.text.toString())){
                                printToastMSGForErrorWarning(applicationContext,
                                    getString(R.string.val_msg_please_enter_valid_expiry_date))
                                return false
                            }
                        } else if (citationLayout.fields!![iOff].name.equals("expiry_month",
                                ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                        ...
                        }  else if (citationLayout.fields!![iOff].name.equals("color",
                                ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                        ...
                        } else if (citationLayout.fields!![iOff].name.equals("lp_number",
                                ignoreCase = true)) {
                                ...
                                BuildConfig.FLAVOR.equals(Constants.FLAVOR_TYPE_PILOTPITTSBURGPA,ignoreCase = true))
                            {
                                    if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                        if ((TextUtils.isEmpty(
                                            ...
                                            mAutoComTextViewLicensePlate?.isAllCaps = true
                                            showKeyboard(this@LprDetails2Activity)
                                            printToastMSG(applicationContext,getString(R.string.val_msg_please_enter_lpr_number)
                                            )
                                            return false
                                        }
                                    }
                            ...
                            if (mAutoComTextViewVinNum != null &&
                                    mAutoComTextViewVinNum?.text.toString().length < 17 ||
                                mAutoComTextViewVinNum != null && mAutoComTextViewVinNum?.text?.toString().equals("Partially Covered")==true)
                                    {
                                if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                    if (TextUtils.isEmpty(
                                                    mAutoComTextViewVinNum?.text.toString().trim())
                        ...
                        } else if (citationLayout.fields!![iOff].name.equals("vin_number",
                                ignoreCase = true)) {
                            ...
                            if (!mApplicationVinList.any { it.direction == inputTextForVin }
                ...
                if (citationLayout.component.equals("Location", ignoreCase = true)) {
                    for (iOff in citationLayout.fields!!.indices) {
                        if (citationLayout.fields!![iOff].name.equals(
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()||mZoneMandatoryForViolationCode.equals("YES")) {
                                if (TextUtils.isEmpty(
                                        mAutoComTextViewZone?.text.toString()
                                            .trim()
                                    )
...
//                                        mAutoComTextViewZone?.setError("")
                            ...
                            if (citationLayout.fields?.get(iOff)?.isRequired.nullSafety() || isPBCReqiredViolation) {
                                if (TextUtils.isEmpty(
                                    ...
                                    AppUtils.showKeyboard(this@LprDetails2Activity)
                                    LogUtil.printToastMSG(
                                        mContext,
                                        getString(R.string.val_msg_please_enter_zone)
                                    )
                    ...
                    for (iOff in citationLayout.fields!!.indices) {
                        if (citationLayout.fields!![iOff].name.equals(
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                ...
                                if(mAutoComTextViewAbbrCode?.text!!.toString().equals("METER EXPIRED",ignoreCase = true)
                                        && TextUtils.isEmpty(
                                               mAutoComTextViewPBCZone?.text.toString().trim()))
                                {
                                    mAutoComTextViewZone?.requestFocus()
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                                        mAutoComTextViewVioTypeCode?.text.toString()
                                            .trim()
                                    )
                                ) {
                            ...
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(
                                        mAutoComTextViewVioType?.text.toString()
                                            .trim()
                                    )
                                ) {
                ...
                if (citationLayout.component.equals("Comments", ignoreCase = true)) {
                    for (iOff in citationLayout.fields!!.indices) {
                        if (citationLayout.fields!![iOff].name.equals(
                                "remark_1", ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(mEtLocationRemarks?.text.toString()
                                            .trim())) {
                                    mEtLocationRemarks?.requestFocus()
                                    mEtLocationRemarks?.isFocusable = true
                                    showKeyboard(this@LprDetails2Activity)
                                    printToastMSG(mContext,
                                    ...
                                    .trim().length>MaxCharcterLimitForComment)
                            {
                                ...
                                "remark_2", ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(mEtLocationRemarks1?.text.toString()
                                            .trim())) {
                                ...
                                "note_1", ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(mEtLocationNotes?.text.toString()
                                            .trim())) {
                                    //mEtLocationNotes.setError(getString(R.string.val_msg_please_enter_note1));
                                    mEtLocationNotes?.requestFocus()
                                    mEtLocationNotes?.isFocusable = true
                                ...
                                "note_2", ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(mEtLocationNotes1?.text.toString()
                                            .trim())) {
                                    //mEtLocationNotes.setError(getString(R.string.val_msg_please_enter_note1));
                                ...
                                "note_3", ignoreCase = true)) {
                            if (citationLayout.fields!![iOff].isRequired.nullSafety()) {
                                if (TextUtils.isEmpty(mEtLocationNotes2?.text.toString()
                                            .trim())) {
                                    //mEtLocationNotes.setError(getString(R.string.val_msg_please_enter_note1));
...
companion object {
    ...
    var instanceLprDetails2Activity: LprDetails2Activity? = null
}

fun isDefaultStateAndNumberPlateFormatValidation()
{
    if(mAutoComTextViewState?.text.toString().equals(mDefaultStateItem) && !plateNumberFormatCheck()
            && isCheckNumberPlateFormat.equals("format",ignoreCase = true)) {
        showCustomAlertDialog(
                mContext, "LPR Number Format Check",
                getString(R.string.is_default_state_plate_validation), getString(R.string.alt_lbl_OK),
                getString(R.string.scr_btn_cancel), this)
    }else{
        previewButtonClicked()
    }
            ...
            if (NetworkCheck.isInternetAvailable(this@LprDetails2Activity)) {
                ...
                if(validImages!!.size>0) {
                    mUploadImageViewModel!!.callUploadScannedImagesAPI(
                        this@LprDetails2Activity,
                        createImagesNameList(validImages),
                        createImageMultipart(validImages),
...
private fun movePreviewScreen()
{
    ...
    val mIntent = Intent(this, LprPreviewActivity::class.java)
    mIntent.putExtra("booklet_id", mLatestCitation!!.citationBooklet)
    mIntent.putExtra("btn_action", mTicketActionButtonEvent)
    mIntent.putExtra("Citation_Images_Link", mCitationImagesLinks as ArrayList<String>)
    startActivityForResult(mIntent, 2020)
...
private val uploadScannedImagesAPIResponseObserver = Observer<Any> {
    when (it) {
        is Resource.Error<*> -> {
            dismissLoader()
            showToast(context = this@LprDetails2Activity, message = it.message.nullSafety())
        }
        ...
        is Resource.Success<*> -> {
            ...
            when (response.status) {
                true -> {
                    ...
                    showToast(
                            context = this@LprDetails2Activity,
...
try {
    val exists = mDb!!.dbDAO!!.isImagePathExists(imagePath)
    if (exists == 0) {
        unUploadFacsimileImage.imagePath = imagePath
        unUploadFacsimileImage.imageLink = ""
        unUploadFacsimileImage.lprNumber = if (mAutoComTextViewLicensePlate!!.text.toString()
                .isNotEmpty()
...
private fun moveTOPreviewScreen(){
    ...
    sharedPreference.write(SharedPrefKey.LAST_SECOND_CHECK,
        isCallLastSecondCheckAPI)
        ...
        if (settingsList != null && settingsList!!.size > 0) {
            for (i in settingsList!!.indices) {
                ...
                if (settingsList!![i].type.equals("IS_CAMERA2_ENABLE",
                                ignoreCase = true) && settingsList!![i].mValue.equals("YES")) {
                    try {
                        mCamera2Setting = "YES"
                    } catch (e: java.lang.Exception) {
                        e.printStackTrace()
                ...
                if (settingsList!![i].type.equals("FULL_VIN_COPY8_LPR_EMPTY_STATE",
                                ignoreCase = true) && settingsList!![i].mValue.equals("YES")) {
                    try {
...
//                                    fname)
                ...
                MediaScannerConnection.scanFile(
                    this@LprDetails2Activity, arrayOf<String>(file.toString()), null
                ) { path, uri -> }
...
private fun setSignatureView() {
    // custom dialog
    val dialog = Dialog(this@LprDetails2Activity)
...
{
    startForResult.launch(Intent(this@LprDetails2Activity, OcrActivity::class.java))
//        camera2Intent()
...
//                    mTvAgency!=null && mTvAgency!!.text!!.toString().equals("TCO")) {
            if(sharedPreference.read(
                    ...
                    false) && mAutoComTextViewLot!=null){
                mLotItem = "8502000"
                if(mTvAgency!=null && mTvAgency!!.text!!.toString().equals("OFF STREET",ignoreCase = true)) {
                    mLotItem = "850107"
                }
                    ...
                    if (mApplicationList != null) {
                        ...
                        for (violation in mApplicationList) {
                                if (violation.mZoneId != null && violation.mZoneId.equals(
                                    ...
                                    violation.mZoneId != null && violation.mZoneId!!.toString().contains("#")
