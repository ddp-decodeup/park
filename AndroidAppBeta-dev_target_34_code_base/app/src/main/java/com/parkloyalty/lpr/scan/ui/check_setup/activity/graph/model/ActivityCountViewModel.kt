...
@HiltViewModel
class ActivityCountViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitActivityCountApi(request: String?) {
        disposables.add(
            service.executeActivityCountAPI(request!!)
