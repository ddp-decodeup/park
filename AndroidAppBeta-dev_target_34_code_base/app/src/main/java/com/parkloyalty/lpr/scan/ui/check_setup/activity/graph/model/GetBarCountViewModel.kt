...
@HiltViewModel
class GetBarCountViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetBarCountApi(request: String?) {
        disposables.add(
            service.executeBarCountAPI(request!!)
