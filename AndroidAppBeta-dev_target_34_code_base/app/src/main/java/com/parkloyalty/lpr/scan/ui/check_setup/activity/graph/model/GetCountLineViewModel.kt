...
@HiltViewModel
class GetCountLineViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetCountLineApi(shift: String?) {
        disposables.add(
            service.executeCountLineAPI(shift!!)
