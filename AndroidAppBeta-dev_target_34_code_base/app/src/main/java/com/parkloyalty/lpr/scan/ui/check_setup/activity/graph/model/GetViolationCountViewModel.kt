...
@HiltViewModel
class GetViolationCountViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitViolationCountApi(request: String?) {
        disposables.add(
            service.executeViolationCountAPI(request!!)
