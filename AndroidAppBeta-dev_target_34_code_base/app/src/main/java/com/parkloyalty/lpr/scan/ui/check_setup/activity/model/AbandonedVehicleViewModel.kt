...
@HiltViewModel
class AbandonedVehicleViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()

    fun hitAbandonedHitApi(mDataFromLprRequest: String?) {
        disposables.add(
            service.executeAbandonedHitAPI(mDataFromLprRequest!!)
