...
@HiltViewModel
class LastSecondCheckViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitLastSecondCheckApi(id: String?) {
        disposables.add(
            service.executeLastSecondCheckAPI(id!!)
