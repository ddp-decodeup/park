...
@HiltViewModel
class SimilarCitationCheckViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitSimilarCitationCheckApi(checkRequest: SimilarCitationCheckRequest?) {
        disposables.add(
            service.executeSimilarCitationCheckAPI(checkRequest)
