...
class MunicipalCommentesAdapter//      AppUtils.sectionFirst = ZebraCommandPrintUtils.setXYforPrintSectionLine(mListData!![mListData!!.size-1],1,"comment",AppUtils.sectionFirst!!)
    (
    val mContext: Context,
    val mListData: List<VehicleListModel>?,
    val listItemSelectListener: ListItemSelectListener?
) : RecyclerView.Adapter<MunicipalCommentesAdapter.ViewHolder>() {
...
//      AppUtils.sectionFirst = AppUtils.setXYforPrintSectionLine(mListData!![mListData!!.size-1],1,"comment",AppUtils.sectionFirst!!)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (mListData != null) {
            ...
            AppUtils.printQueryStringBuilder = ZebraCommandPrintUtils.setXYforMunicipalPrint(mListData!!,position,"comment",
                AppUtils.printQueryStringBuilder!!)
