...
class MunicipalOfficerListAdapter//        AppUtils.sectionFirst = ZebraCommandPrintUtils.setXYforPrintSectionLine(mListData!![mListData!!.size-1],1,"citation",AppUtils.sectionFirst!!)
    (
    val mContext: Context,
    val mListData: List<VehicleListModel>?,
    val listItemSelectListener: ListItemSelectListener?
) : RecyclerView.Adapter<MunicipalOfficerListAdapter.ViewHolder>() {
...
//                        mContext.getResources().getDimension(R.dimen.print_label_9));
            ...
            AppUtils.printQueryStringBuilder = ZebraCommandPrintUtils.setXYforMunicipalPrint(mListData!!,position,"Officer",
                AppUtils.printQueryStringBuilder!!)
