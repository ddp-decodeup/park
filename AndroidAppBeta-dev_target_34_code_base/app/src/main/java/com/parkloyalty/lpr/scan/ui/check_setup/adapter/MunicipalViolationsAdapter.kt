...
class MunicipalViolationsAdapter
    (
    val mContext: Context,
    val mListData: List<VehicleListModel>?,
    val listItemSelectListener: ListItemSelectListener?
) : RecyclerView.Adapter<MunicipalViolationsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        try {
            if (mListData != null) {
                ...
                AppUtils.printQueryStringBuilder = ZebraCommandPrintUtils.setXYforMunicipalPrint(mListData!!,position,PRINT_SECTION_VIOLATION,
                    AppUtils.printQueryStringBuilder!!)
