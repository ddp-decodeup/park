...
class VehicalListAdapter//        AppUtils.sectionFirst = AppUtils.setXYforPrintSectionLine(mListData!![mListData!!.size-1],1,"citation",AppUtils.sectionFirst!!)
    (
    val mContext: Context,
    val mListData: List<VehicleListModel>?,
    val listItemSelectListener: ListItemSelectListener?
) : RecyclerView.Adapter<VehicalListAdapter.ViewHolder>() {
...
//        AppUtils.sectionFirst = AppUtils.setXYforPrintSectionLine(mListData!![mListData!!.size-1],1,"citation",AppUtils.sectionFirst!!)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (mListData != null) {
            ...
            holder.tvFieldValue.text = vehicleDataItem!!.offTypeFirst?.replace(Constants.COMMA," ")
