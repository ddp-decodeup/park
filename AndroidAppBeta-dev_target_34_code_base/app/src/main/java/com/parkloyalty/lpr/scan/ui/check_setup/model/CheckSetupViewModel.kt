...
@HiltViewModel
class CheckSetupViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitCheckSetupApi(request: CheckSetupRequest?) {
        disposables.add(
            service.executeCheckSetupAPI()
