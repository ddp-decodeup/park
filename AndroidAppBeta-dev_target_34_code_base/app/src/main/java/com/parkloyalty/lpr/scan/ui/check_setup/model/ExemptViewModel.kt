...
@HiltViewModel
class ExemptViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetExemptApi(exemptRequest: ExemptRequest?) {
        disposables.add(
            service.executeGetExemptAPI(exemptRequest)
