...
@HiltViewModel
class MeterViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetMeterApi(meterRequest: MeterRequest?) {
        disposables.add(
            service.executeGetMeterAPI(meterRequest)
