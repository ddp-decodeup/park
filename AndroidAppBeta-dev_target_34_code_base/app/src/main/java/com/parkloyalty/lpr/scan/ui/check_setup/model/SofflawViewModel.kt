...
@HiltViewModel
class SofflawViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetSofflawApi(sofflawRequest: SofflawRequest?) {
        disposables.add(
            service.executeGetSofflawAPI(sofflawRequest)
