...
@HiltViewModel
class TimingViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetTimingApi(timingRequest: TimingRequest?) {
        disposables.add(
            service.executeGetTimingAPI(timingRequest)
