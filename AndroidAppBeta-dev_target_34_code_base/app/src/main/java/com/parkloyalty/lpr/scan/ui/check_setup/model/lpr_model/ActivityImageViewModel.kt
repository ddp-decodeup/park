...
@HiltViewModel
class ActivityImageViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitUploadActivityImageApi(pushEventRequest: ActivityImageUploadRequest?) {
        disposables.add(
            service.executeActivityImagesUploadAPI(pushEventRequest)
