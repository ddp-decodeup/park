...
@HiltViewModel
class LprScanLoggerViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitLprScanLoggerApi(mDataFromLprRequest: LprScanLoggerRequest?) {
        disposables.add(
            service.executeLprScanLoggerAPI(mDataFromLprRequest)
