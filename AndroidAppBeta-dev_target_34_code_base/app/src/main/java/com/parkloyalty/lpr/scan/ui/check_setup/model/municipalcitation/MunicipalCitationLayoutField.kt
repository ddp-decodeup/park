...
data class MunicipalCitationLayoutField(
    ...
    var dependantField: Boolean? = null,
    ...
    var optionsCheckBox: List<MunicipalCitationOptionsCheckBox>? = null
) : Parcelable
