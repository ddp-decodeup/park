...
@HiltViewModel
class CreateTicketViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitCreateTicketApi(createTicketRequest: CreateTicketRequest?) {
        disposables.add(
            service.executeCreateTicketAPI(createTicketRequest)
