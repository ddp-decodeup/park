...
data class AddTimingData(
    @field:JsonProperty("arrial_status")
    @get:JsonProperty("arrial_status")
    ...
    var location: AddTimingLocation? = null,
    ...
    var isAbandonVehicle: Boolean? = false
) : Parcelable
