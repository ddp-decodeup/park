...
@HiltViewModel
class AddTimingViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitAddTimingApi(addTimingRequest: AddTimingRequest?) {
        disposables.add(
            service.executeAddTimingAPI(addTimingRequest)
