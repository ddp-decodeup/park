...
@HiltViewModel
class TimingMarkBulkViewModel  @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitTimigMarkBulkApi(mDataFromLprRequest: TimingMarkBulkRequest?) {
        disposables.add(
                service.executeTimingMarkBulkAPI(mDataFromLprRequest!!)
