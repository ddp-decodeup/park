...
@HiltViewModel
class LprEndSessionViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitEndSessionApi(sessionId: LprEndSessionRequest?) {
        disposables.add(
            service.executeLprEndSessionAPI(sessionId)
