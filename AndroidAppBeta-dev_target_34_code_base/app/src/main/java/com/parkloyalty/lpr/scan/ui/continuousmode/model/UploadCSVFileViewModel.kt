...
@HiltViewModel
class UploadCSVFileViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitUploadCsvApi(mIDList: UploadCsvLinksRequest?) {
        disposables.add(
            service.executeUploadCsvAPI(mIDList)
