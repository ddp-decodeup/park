...
@HiltViewModel
class PayBySpaceDataSetViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitPayBySpaceDataSetApi(id: String?) {
        disposables.add(
            service.executePayBySpaceDataSetAPI(id!!)
