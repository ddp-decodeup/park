...
@HiltViewModel
class CitationNumberModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetCitationNumberApi(citationNumberRequest: CitationNumberRequest?) {
        disposables.add(
            service.executeCitationNumberAPI(citationNumberRequest)
