...
@HiltViewModel
class ActivityLogViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitActivityLogApi(activityUpdateRequest: ActivityUpdateRequest?) {
        disposables.add(
            service.executeActivityLogAPI(activityUpdateRequest)
