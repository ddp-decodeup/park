...
@HiltViewModel
class ForgetPasswordViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitForgetPasswordApi(forgetPasswordActivity: ForgetPasswordRequest?) {
        disposables.add(
            service.executeForgetPassAPI(forgetPasswordActivity)
