...
import com.parkloyalty.lpr.scan.databinding.ActivityMunicipalCitationAddNotesAndImagesBinding
...
import com.parkloyalty.lpr.scan.ui.ticket.ViewPagerBannerAddNoteAdapter
...
class MunicipalCitationAddNotesAndImagesActivity : BaseActivity(), CustomDialogHelper {
    ...
    private lateinit var binding: ActivityMunicipalCitationAddNotesAndImagesBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMunicipalCitationAddNotesAndImagesBinding.inflate(layoutInflater)
        setContentView(binding.root)
        findViewsByViewBinding()
        setupClickListeners()

        setFullScreenUI()
        mContext = this@MunicipalCitationAddNotesAndImagesActivity
        addObservers()
        val directory = File(
        ...
        setCrossClearButton(context = this@MunicipalCitationAddNotesAndImagesActivity, textInputLayout = textInputLayoutNote1, appCompatAutoCompleteTextView = mEditTextViewTextViewNote1)
        setCrossClearButton(context = this@MunicipalCitationAddNotesAndImagesActivity, textInputLayout = textInputLayoutNote2, appCompatAutoCompleteTextView = mEditTextViewTextViewNote2)
        setCrossClearButton(context = this@MunicipalCitationAddNotesAndImagesActivity, textInputLayout = textInputLayoutNote3, appCompatAutoCompleteTextView = mEditTextViewTextViewNote3)
    }

    private fun findViewsByViewBinding() {
        textInputEditTextNote = binding.layoutContentMunicipalCitationAddNoteImages.etNote
        appCompatImageViewMenu =
            binding.layoutContentMunicipalCitationAddNoteImages.layoutDashboardHeader.imgOptions
        mViewPagerBanner =
            binding.layoutContentMunicipalCitationAddNoteImages.layoutContentBanner.pagerBanner
        pagerIndicator =
            binding.layoutContentMunicipalCitationAddNoteImages.layoutContentBanner.viewPagerCountDots
        mEditTextViewTextViewNote1 =
            binding.layoutContentMunicipalCitationAddNoteImages.AutoComTextViewNote1
        mEditTextViewTextViewNote2 =
            binding.layoutContentMunicipalCitationAddNoteImages.AutoComTextViewNote2
        mEditTextViewTextViewNote3 =
            binding.layoutContentMunicipalCitationAddNoteImages.AutoComTextViewNote3
        textInputLayoutNote1 =
            binding.layoutContentMunicipalCitationAddNoteImages.textInputLayoutNote1
        textInputLayoutNote2 =
            binding.layoutContentMunicipalCitationAddNoteImages.textInputLayoutNote2
        textInputLayoutNote3 =
            binding.layoutContentMunicipalCitationAddNoteImages.textInputLayoutNote3
        clParent = binding.clParent
    }

    private fun setupClickListeners() {
        binding.layoutContentMunicipalCitationAddNoteImages.btnDone.setOnClickListener {
            //if (isFormValid) {
            isUploadLinkCalledOnce = true
            callAddNotesApi()
        }

        binding.layoutContentMunicipalCitationAddNoteImages.ivCamera.setOnClickListener {
            requestPermission()
        }
    }
    ...
    private fun init() {
        ...
        mBannerAdapter = ViewPagerBannerAddNoteAdapter(
            this@MunicipalCitationAddNotesAndImagesActivity,
...
//             setCameraImages();
        ...
        if (notesDatasetResponseList != null && notesDatasetResponseList.isNotEmpty()) {
            ...
            AppUtils.hideSoftKeyboard(this@MunicipalCitationAddNotesAndImagesActivity)
        }
    }
    ...
    private fun addObservers() {
        addNotesViewModel?.response?.observe(this@MunicipalCitationAddNotesAndImagesActivity, addNotesResponseObserver)
        addImageViewModel?.response?.observe(this@MunicipalCitationAddNotesAndImagesActivity, addImageResponseObserver)
        getNotesViewModel?.response?.observe(this@MunicipalCitationAddNotesAndImagesActivity, getNotesResponseObserver)
        mUploadImageViewModel?.response?.observe(this@MunicipalCitationAddNotesAndImagesActivity, uploadImageResponseObserver)
        mDownloadBitmapFIleViewModel?.response?.observe(this@MunicipalCitationAddNotesAndImagesActivity, downloadBitmapFileResponseObserver)
    }
    ...
    private fun requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (PermissionUtils.requestCameraAndStoragePermission(this@MunicipalCitationAddNotesAndImagesActivity)) {
                cameraIntent()
            }
        } else {
            cameraIntent()
    ...
    private fun getOutputPhotoFile(): Uri? {
            ...
            if (Build.VERSION.SDK_INT > 23) {
                ...
                path = FileProvider.getUriForFile(mContext!!, this@MunicipalCitationAddNotesAndImagesActivity.packageName + ".provider", file)
            } else {
    ...
    protected fun setUiPageViewController(count: Int) {
        try {
            ...
            for (i in 0 until mDotsCount) {
                mDots!![i] = ImageView(this@MunicipalCitationAddNotesAndImagesActivity)
...
//                }
            ...
            val adapter = ArrayAdapter(this@MunicipalCitationAddNotesAndImagesActivity,
...
//             }
    private fun isFormValid(): Boolean{
            try {
                if (TextUtils.isEmpty(mEditTextViewTextViewNote3?.getText().toString().trim())) {
                    ...
                    AppUtils.showKeyboard(this@MunicipalCitationAddNotesAndImagesActivity)
    ...
    private fun callUploadImagesUrl() {
        if (isInternetAvailable(this@MunicipalCitationAddNotesAndImagesActivity)) {
