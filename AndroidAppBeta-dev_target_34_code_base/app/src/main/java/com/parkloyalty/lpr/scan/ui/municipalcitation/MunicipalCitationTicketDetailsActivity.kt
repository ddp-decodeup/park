...
import com.parkloyalty.lpr.scan.databinding.ActivityMunicipalCitationTicketDetailsBinding
...
class MunicipalCitationTicketDetailsActivity : BaseActivity(), PrintInterface {
    //Start of UI Views
    ...
    var tvMotoristName: AppCompatTextView? = null
    var tvMotoristDateOfBirth: AppCompatTextView? = null
    var tvMotoristDlNUmber: AppCompatTextView? = null
    var tvMotoristAddress: AppCompatTextView? = null
    var tvMotoristInformation: AppCompatTextView? = null
    lateinit var layVehicleDetails: LinearLayoutCompat
    lateinit var layMotoristDetails: LinearLayoutCompat
    //End of UI Views
    ...
    private val bluetoothPermissionLauncher =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            if (granted) {
                ...
                BluetoothPermissionUtil.requestBluetoothSetting(this@MunicipalCitationTicketDetailsActivity)
            }
        }

    private lateinit var binding: ActivityMunicipalCitationTicketDetailsBinding


    @RequiresPermission(Manifest.permission.BLUETOOTH_CONNECT)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMunicipalCitationTicketDetailsBinding.inflate(layoutInflater)
        ...
        if (LogUtil.getPrinterTypeForPrint() == PrinterType.STAR_PRINTER) {
            ...
            starPrinterUseCase?.initialize(this@MunicipalCitationTicketDetailsActivity)
            ...
            zebraPrinterUseCase?.initialize(
                activity = this@MunicipalCitationTicketDetailsActivity,
    ...
    private fun findViewsByViewBinding() {
        mTextViewVoilationDetails =
            binding.layoutContentMunicipalCitationTicketDetails.tvVoilationDetails
        mTextViewTicketNumber = binding.layoutContentMunicipalCitationTicketDetails.tvTicketNumber
        mTextViewTicketDate = binding.layoutContentMunicipalCitationTicketDetails.tvTicketDate
        mTextViewAddress = binding.layoutContentMunicipalCitationTicketDetails.tvAddressValue
        mTextViewVehicle = binding.layoutContentMunicipalCitationTicketDetails.tvVehicleValue
        mTextViewTicketSuccess = binding.layoutContentMunicipalCitationTicketDetails.ivTicketSuccess
        mTextViewTicketMsg = binding.layoutContentMunicipalCitationTicketDetails.tvTicketMsg
        mTextViewSpace = binding.layoutContentMunicipalCitationTicketDetails.tvSpace
        mTextViewVin = binding.layoutContentMunicipalCitationTicketDetails.tvVin
        mTextViewCitationType = binding.layoutContentMunicipalCitationTicketDetails.tvCitationType
        mTextViewLot = binding.layoutContentMunicipalCitationTicketDetails.tvLot
        layCitationOptions = binding.layoutContentMunicipalCitationTicketDetails.layCitationOptions
        layCitationButtons = binding.layoutContentMunicipalCitationTicketDetails.layCitationButtons
        mBtnIssueMore = binding.layoutContentMunicipalCitationTicketDetails.ivIssueMore
        mBtnCancelTicket = binding.layoutContentMunicipalCitationTicketDetails.btnCancelTicket
        mBtnVoidAndReissue = binding.layoutContentMunicipalCitationTicketDetails.btnDashboard
        mBTNBack = binding.layoutContentMunicipalCitationTicketDetails.layoutDashboardHeader.imgBack
        checkBoxDriveOff = binding.layoutContentMunicipalCitationTicketDetails.checkDriveOff
        checkBoxTvr = binding.layoutContentMunicipalCitationTicketDetails.checkTvr
        selectedCheckBoxValue =
            binding.layoutContentMunicipalCitationTicketDetails.textSelectCheckbox
        linearLayoutCompatPrint = binding.layoutContentMunicipalCitationTicketDetails.llPrint
        ivPrintBtn = binding.layoutContentMunicipalCitationTicketDetails.ivPrint
        linearLayoutCompatIssueMore =
            binding.layoutContentMunicipalCitationTicketDetails.llIssuemore
        linearLayoutCompatScan = binding.layoutContentMunicipalCitationTicketDetails.llScan
        linearLayoutCompatLot = binding.layoutContentMunicipalCitationTicketDetails.llLot
        linearLayoutCompatSpace = binding.layoutContentMunicipalCitationTicketDetails.llSpace
        linearLayoutCompatVin = binding.layoutContentMunicipalCitationTicketDetails.llVin
        linearLayoutCompatCitationType =
            binding.layoutContentMunicipalCitationTicketDetails.llCitationType
        appCompatImageViewHomeIcon =
            binding.layoutContentMunicipalCitationTicketDetails.layoutDashboardHeader.imgOptions
        mContentMainLayout = binding.layoutContentMunicipalCitationTicketDetails.contentMain
        mCheckLinearLayout = binding.layoutContentMunicipalCitationTicketDetails.layCheckBox

        tvMotoristName = binding.layoutContentMunicipalCitationTicketDetails.tvMotoristName
        tvMotoristDateOfBirth =
            binding.layoutContentMunicipalCitationTicketDetails.tvMotoristDateOfBirth
        tvMotoristDlNUmber = binding.layoutContentMunicipalCitationTicketDetails.tvMotoristDlNUmber
        tvMotoristAddress = binding.layoutContentMunicipalCitationTicketDetails.tvMotoristAddress
        tvMotoristInformation =
            binding.layoutContentMunicipalCitationTicketDetails.tvMotoristInformation
        layVehicleDetails = binding.layoutContentMunicipalCitationTicketDetails.layVehicleDetails
        layMotoristDetails = binding.layoutContentMunicipalCitationTicketDetails.llMotoristDetails
    }

    private fun setupClickListeners() {
        val sharedClickForRecord = View.OnClickListener { v ->
            when (v?.id) {
                binding.layoutContentMunicipalCitationTicketDetails.ivRecord.id, binding.layoutContentMunicipalCitationTicketDetails.llRecord.id -> {
...
//                    showAddNoteDialog();
                    val mStartActivity =
                        Intent(
                            this@MunicipalCitationTicketDetailsActivity,
                            MunicipalCitationAddNotesAndImagesActivity::class.java
                        )
        ...
        binding.layoutContentMunicipalCitationTicketDetails.ivRecord.setOnClickListener(
            sharedClickForRecord
        )
        binding.layoutContentMunicipalCitationTicketDetails.llRecord.setOnClickListener(
            sharedClickForRecord
        )

        binding.layoutContentMunicipalCitationTicketDetails.btnDashboard.setOnClickListener {
        ...
        binding.layoutContentMunicipalCitationTicketDetails.ivScan.setOnClickListener {
        ...
        binding.layoutContentMunicipalCitationTicketDetails.ivPrint.setOnClickListener {
            BluetoothPermissionUtil.checkBluetoothPermissions(
                activity = this,
                permissionLauncher = bluetoothPermissionLauncher
            ) {
        ...
        binding.layoutContentMunicipalCitationTicketDetails.ivIssueMore.setOnClickListener {
            AppUtils.showCustomAlertDialog(
                ...
                object : CustomDialogHelper {
                    ...
                    override fun onYesButtonClickParam(msg: String?) {
                        ...
                        val mIntent1 = Intent(
                            this@MunicipalCitationTicketDetailsActivity,
                            MunicipalCitationDetailsActivity::class.java
                        )
        ...
        binding.layoutContentMunicipalCitationTicketDetails.btnRegenerateFacsimile.setOnClickListener {
            BluetoothPermissionUtil.checkBluetoothPermissions(
                activity = this,
                permissionLauncher = bluetoothPermissionLauncher
            ) {
                val mStartActivity =
                    Intent(
                        this@MunicipalCitationTicketDetailsActivity,
                        MunicipalCitationReprintReuploadActivity::class.java
                    )
    ...
    override fun onResume() {
        ...
        try {
            ...
            handler.postDelayed({
                ...
                AppUtils.setLprLock(lockLprModel, this@MunicipalCitationTicketDetailsActivity, sharedPreference)
...
//        }
    ...
    private fun callTicketCancelApi(Id: String?, note: String, reason: String) {
        if (isInternetAvailable(this@MunicipalCitationTicketDetailsActivity)) {
...
//                    mTextViewVehicle?.text = "$mMake, $mColor, $mLprNumber, $mState, $mExpireYear"
                ...
                ).nullOrEmptySafety(getString(R.string.scr_lbl_motorist_details))

                if (intent.hasExtra(INTENT_KEY_MOTORIST_NAME)) {
                    tvMotoristName?.text =  intent.getStringExtra(INTENT_KEY_MOTORIST_NAME)
                }
                if (intent.hasExtra(INTENT_KEY_MOTORIST_DOB)) {
                    tvMotoristDateOfBirth?.text =
                        getString(R.string.scr_lbl_motorist_date_of_birth) + ":" + intent.getStringExtra(
                            INTENT_KEY_MOTORIST_DOB
                        )
                }
                if (intent.hasExtra(INTENT_KEY_MOTORIST_DL_NUMBER)) {
                    tvMotoristDlNUmber?.text =
                        getString(R.string.scr_lbl_motorist_dl_number) + ":" + intent.getStringExtra(
                            INTENT_KEY_MOTORIST_DL_NUMBER
                        )
                }
                if (intent.hasExtra(INTENT_KEY_MOTORIST_ADDRESS)) {
                    tvMotoristAddress?.text =  intent.getStringExtra(INTENT_KEY_MOTORIST_ADDRESS)
                }
                ...
                if (intent.getStringExtra("ticket_id") != null) {
                    ...
                    if (mTicketId.equals("none", ignoreCase = true)) {
                        ...
                        mTextViewTicketMsg?.text =
                                getString(R.string.val_msg_please_enter_municipal_citation_ticket_pending)
                        mBtnCancelTicket?.visibility = View.GONE
                        linearLayoutCompatIssueMore?.visibility = View.GONE
                    } else {
                        mTextViewTicketSuccess?.setBackgroundDrawable(getDrawable(R.drawable.ic_ticket_details))
                        mTextViewTicketMsg?.text = getString(R.string.msg_municipal_ticket_posted)
                        ...
                        try {
                            if (tag.equals(DynamicAPIPath.POST_CANCEL, ignoreCase = true)) {
                                ...
                                if (responseModel != null && responseModel.success!!) {
                                    LogUtil.printToastMSG(this@MunicipalCitationTicketDetailsActivity, responseModel.msg)
                                    mDb!!.dbDAO!!.updateCitationBooklet(1, mCitationNumberId)
                                    if (mTag.equals(DATASET_VOID_AND_REISSUE_REASON_LIST, ignoreCase = true)) {
                                        ...
                                        val mIntent = Intent(this@MunicipalCitationTicketDetailsActivity,
                                            MunicipalCitationDetailsActivity::class.java)
                                        mIntent.putExtra("from_scr", "ticket_details")
                                        mIntent.putExtra("booklet_id", mCitationNumberId.toString())
                                        mIntent.putExtra("btn_action", "VoidReissue")
...
//                                    sharedPreference.getInstance(TicketDetailsActivity.this).write(SharedPrefKey.isCancelTicket, "true");
                                ...
                                if (responseModel != null && responseModel.isStatus) {
                                    if (PermissionUtils.requestCameraAndStoragePermission(this@MunicipalCitationTicketDetailsActivity) && responseModel.metadata!![0].url?.length!! > 0) {
                ...
                Status.ERROR -> {
                    ...
                    dismissLoader()
                    LogUtil.printToastMSG(this@MunicipalCitationTicketDetailsActivity, getString(R.string.err_msg_error))
                    try {
...
//        val appCompatLayout: LinearLayoutCompat = mDialog.findViewById(R.id.layPopup)
            ...
            setAccessibilityForTextInputLayoutDropdownButtons(this@MunicipalCitationTicketDetailsActivity, textInputStatus)
...
//                        )
                        ...
                        MediaScannerConnection.scanFile(
                            this@MunicipalCitationTicketDetailsActivity, arrayOf<String>(file.toString()), null
                        ) { path, uri -> }
...
//            Toast.makeText(mContext,mAmount, Toast.LENGTH_SHORT).show()
    ...
    private fun isOverTimeParkingAPICallingSettingDrive() {
        try {
            ...
            if (timingRecordCarryForwardValue != null&& timingRecordCarryForwardValue.equals("YES")) {
                callAddTimingApi()
            }
        } catch (e: Exception) {
            e.printStackTrace()
