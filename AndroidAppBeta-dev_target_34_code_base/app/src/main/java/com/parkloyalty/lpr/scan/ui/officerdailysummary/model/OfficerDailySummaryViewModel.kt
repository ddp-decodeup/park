...
@HiltViewModel
class OfficerDailySummaryViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse?>()
    fun hitOfficerDailySummaryApi(shift: String?) {
        disposables.add(
            service.executeOfficerDailySummaryAPI(shift!!)
