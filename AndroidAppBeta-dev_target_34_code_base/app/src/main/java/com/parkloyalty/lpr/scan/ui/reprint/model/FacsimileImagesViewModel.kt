...
@HiltViewModel
class FacsimileImagesViewModel  @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitFacsimileImagesApi(checkRequest: String?) {
        disposables.add(
                service.executeFacsimileImageAPI(checkRequest)
