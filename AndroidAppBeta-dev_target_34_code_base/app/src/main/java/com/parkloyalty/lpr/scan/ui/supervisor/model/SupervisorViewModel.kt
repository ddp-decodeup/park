...
@HiltViewModel
class SupervisorViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitSupervisorAPI(endPoint: String?) {
        disposables.add(
            service.executeSupervisorAPI(endPoint!!)
