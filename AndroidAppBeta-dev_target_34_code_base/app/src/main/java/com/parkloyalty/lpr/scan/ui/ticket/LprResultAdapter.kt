...
class LprResultAdapter : RecyclerView.Adapter<LprResultAdapter.ViewHolder> {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (mListData != null) {
            holder.mImageViewNumberPlate.visibility = View.GONE
            holder.llImageContainer.visibility = View.GONE
...
//                }
    ...
    inner class ViewHolder internal constructor(itemView: View) :
        ...
        var llImageContainer: LinearLayoutCompat
