...
@HiltViewModel
class DriveOffTVRViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun driveOffTvrAPI(driveOffTvrRequest: DriveOffTvrRequest?, mTicketNo: String?) {
        disposables.add(
            service.executeDriveOffTvrAPI(driveOffTvrRequest, mTicketNo!!)
