...
@HiltViewModel
class GetNotesViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitGetNotesAPI(mTicketNo: String?) {
        disposables.add(
            service.executeGetNotesAPI(mTicketNo!!)
