...
@HiltViewModel
class TicketCancelViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitTicketCancelApi(cancelRequest: TicketCancelRequest?, id: String?) {
        disposables.add(
            service.executeTicketCancelAPI(cancelRequest, id!!)
