...
@HiltViewModel
class UpdateMarkViewModel @Inject constructor(private val service: Service) : ViewModel() {
    private val disposables = CompositeDisposable()
    val response = MutableLiveData<ApiResponse>()
    fun hitUpdateMarkApi(updateMarkRequest: UpdateMarkRequest?, id: String?) {
        disposables.add(
            service.executeUpdateMarkAPI(updateMarkRequest, id!!)
