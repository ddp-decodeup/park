...
import com.twotechnologies.n5library.printer.*
...
//************************************************************************
    ...
    private val srvReady: N5ReadyListener = N5ReadyHandler(this, N5ReadyListener.ACTION_N5_READY)
    //************************************************************************
    /** Listen for lost connection to N5Service  */ //************************************************************************
    private val srvNotReady: N5ReadyListener =
        N5ReadyHandler(this, N5ReadyListener.ACTION_N5_NOT_READY)
    ...
    //***********************************************************************
    /** Print Complete  */ //***********************************************************************
    private val prtComplete: PrtCompleteListener = object : PrtCompleteListener(this) {
...
//***********************************************************************
    ...
    private val prtStatusChangeListener: PrtStatusChangeListener =
        object : PrtStatusChangeListener(this) {
            override fun onReceive(context: Context, intent: Intent) {
...
//                    setPrtTitleColor(titleBar)
    ...
    private fun printerStatus(){
        ...
        titleBusy = ContextCompat.getColor(this, R.color.titleBusy)
    }
...
//            try {
//                Toast.makeText(this@XfPrinterActivity,"FEED WORKED",Toast.LENGTH_SHORT).show()
...
//            paint.getTypeface(context.getResources().getFont(R.font.sf_pro_text_semibold));
            ...
            if (mText.equals("R", ignoreCase = true)) {
                canvas.drawText((mText), (x - 130).toFloat(),
                    AppUtils.printLabelHeight(screenHeight).toFloat(), paint)
            } else {
                canvas.drawText((mText), (x - 140).toFloat(),
                    AppUtils.printLabelHeight(screenHeight).toFloat(), paint)
            }
            return bitmap
        } catch (e: Exception) {
