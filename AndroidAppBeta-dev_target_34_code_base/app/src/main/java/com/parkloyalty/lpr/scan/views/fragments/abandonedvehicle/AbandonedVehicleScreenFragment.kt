package com.parkloyalty.lpr.scan.views.fragments.abandonedvehicle
...
@AndroidEntryPoint
class AbandonedVehicleScreenFragment : BaseFragment<FragmentSettingsScreenBinding>() {
    private val mainActivityViewModel: MainActivityViewModel by activityViewModels()
    //Can be used later for settings specific logic
    private val abandonedVehicleScreenViewModel: AbandonedVehicleScreenViewModel by viewModels()
