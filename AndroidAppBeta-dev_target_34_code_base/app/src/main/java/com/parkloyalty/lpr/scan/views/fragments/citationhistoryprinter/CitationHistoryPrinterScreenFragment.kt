...
@AndroidEntryPoint
class CitationHistoryPrinterScreenFragment : BaseFragment<FragmentSettingsScreenBinding>() {
    private val mainActivityViewModel: MainActivityViewModel by activityViewModels()
    //Can be used later for settings specific logic
    private val citationHistoryPrinterScreenViewModel: CitationHistoryPrinterScreenViewModel by viewModels()
