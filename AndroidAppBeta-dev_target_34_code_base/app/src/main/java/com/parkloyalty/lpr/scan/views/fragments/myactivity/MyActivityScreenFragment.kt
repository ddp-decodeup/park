package com.parkloyalty.lpr.scan.views.fragments.myactivity
...
import com.parkloyalty.lpr.scan.databinding.FragmentMyActivityScreenBinding
...
@AndroidEntryPoint
class MyActivityScreenFragment : BaseFragment<FragmentMyActivityScreenBinding>() {
    private val mainActivityViewModel: MainActivityViewModel by activityViewModels()
    //Can be used later for settings specific logic
    private val myActivityScreenViewModel: MyActivityScreenViewModel by viewModels()



    override fun inflateBinding(inflater: LayoutInflater, container: ViewGroup?) =
        FragmentMyActivityScreenBinding.inflate(inflater, container, false)
